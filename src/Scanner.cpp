...
void Scanner::Init() {
	...
	for (i = 13; i <= 13; ++i) start.set(i, 228);
	for (i = 48; i <= 57; ++i) start.set(i, 229);
	for (i = 98; i <= 100; ++i) start.set(i, 230);
	for (i = 103; i <= 108; ++i) start.set(i, 230);
	for (i = 112; i <= 113; ++i) start.set(i, 230);
	for (i = 116; i <= 118; ++i) start.set(i, 230);
	for (i = 121; i <= 122; ++i) start.set(i, 230);
	for (i = 170; i <= 170; ++i) start.set(i, 230);
	for (i = 181; i <= 181; ++i) start.set(i, 230);
	for (i = 186; i <= 186; ++i) start.set(i, 230);
	for (i = 192; i <= 214; ++i) start.set(i, 230);
	for (i = 216; i <= 246; ++i) start.set(i, 230);
	for (i = 248; i <= 566; ++i) start.set(i, 230);
	for (i = 592; i <= 705; ++i) start.set(i, 230);
	for (i = 710; i <= 721; ++i) start.set(i, 230);
	for (i = 736; i <= 740; ++i) start.set(i, 230);
	for (i = 750; i <= 750; ++i) start.set(i, 230);
	for (i = 890; i <= 890; ++i) start.set(i, 230);
	for (i = 902; i <= 902; ++i) start.set(i, 230);
	for (i = 904; i <= 906; ++i) start.set(i, 230);
	for (i = 908; i <= 908; ++i) start.set(i, 230);
	for (i = 910; i <= 929; ++i) start.set(i, 230);
	for (i = 931; i <= 974; ++i) start.set(i, 230);
	for (i = 976; i <= 1013; ++i) start.set(i, 230);
	for (i = 1015; i <= 1019; ++i) start.set(i, 230);
	for (i = 1024; i <= 1153; ++i) start.set(i, 230);
	for (i = 1162; i <= 1230; ++i) start.set(i, 230);
	for (i = 1232; i <= 1269; ++i) start.set(i, 230);
	for (i = 1272; i <= 1273; ++i) start.set(i, 230);
	for (i = 1280; i <= 1295; ++i) start.set(i, 230);
	for (i = 1329; i <= 1366; ++i) start.set(i, 230);
	for (i = 1369; i <= 1369; ++i) start.set(i, 230);
	for (i = 1377; i <= 1415; ++i) start.set(i, 230);
	for (i = 1488; i <= 1514; ++i) start.set(i, 230);
	for (i = 1520; i <= 1522; ++i) start.set(i, 230);
	for (i = 1569; i <= 1594; ++i) start.set(i, 230);
	for (i = 1600; i <= 1610; ++i) start.set(i, 230);
	for (i = 1646; i <= 1647; ++i) start.set(i, 230);
	for (i = 1649; i <= 1747; ++i) start.set(i, 230);
	for (i = 1749; i <= 1749; ++i) start.set(i, 230);
	for (i = 1765; i <= 1766; ++i) start.set(i, 230);
	for (i = 1774; i <= 1775; ++i) start.set(i, 230);
	for (i = 1786; i <= 1788; ++i) start.set(i, 230);
	for (i = 1791; i <= 1791; ++i) start.set(i, 230);
	for (i = 1808; i <= 1808; ++i) start.set(i, 230);
	for (i = 1810; i <= 1839; ++i) start.set(i, 230);
	for (i = 1869; i <= 1871; ++i) start.set(i, 230);
	for (i = 1920; i <= 1957; ++i) start.set(i, 230);
	for (i = 1969; i <= 1969; ++i) start.set(i, 230);
	for (i = 2308; i <= 2361; ++i) start.set(i, 230);
	for (i = 2365; i <= 2365; ++i) start.set(i, 230);
	for (i = 2384; i <= 2384; ++i) start.set(i, 230);
	for (i = 2392; i <= 2401; ++i) start.set(i, 230);
	for (i = 2437; i <= 2444; ++i) start.set(i, 230);
	for (i = 2447; i <= 2448; ++i) start.set(i, 230);
	for (i = 2451; i <= 2472; ++i) start.set(i, 230);
	for (i = 2474; i <= 2480; ++i) start.set(i, 230);
	for (i = 2482; i <= 2482; ++i) start.set(i, 230);
	for (i = 2486; i <= 2489; ++i) start.set(i, 230);
	for (i = 2493; i <= 2493; ++i) start.set(i, 230);
	for (i = 2524; i <= 2525; ++i) start.set(i, 230);
	for (i = 2527; i <= 2529; ++i) start.set(i, 230);
	for (i = 2544; i <= 2545; ++i) start.set(i, 230);
	for (i = 2565; i <= 2570; ++i) start.set(i, 230);
	for (i = 2575; i <= 2576; ++i) start.set(i, 230);
	for (i = 2579; i <= 2600; ++i) start.set(i, 230);
	for (i = 2602; i <= 2608; ++i) start.set(i, 230);
	for (i = 2610; i <= 2611; ++i) start.set(i, 230);
	for (i = 2613; i <= 2614; ++i) start.set(i, 230);
	for (i = 2616; i <= 2617; ++i) start.set(i, 230);
	for (i = 2649; i <= 2652; ++i) start.set(i, 230);
	for (i = 2654; i <= 2654; ++i) start.set(i, 230);
	for (i = 2674; i <= 2676; ++i) start.set(i, 230);
	for (i = 2693; i <= 2701; ++i) start.set(i, 230);
	for (i = 2703; i <= 2705; ++i) start.set(i, 230);
	for (i = 2707; i <= 2728; ++i) start.set(i, 230);
	for (i = 2730; i <= 2736; ++i) start.set(i, 230);
	for (i = 2738; i <= 2739; ++i) start.set(i, 230);
	for (i = 2741; i <= 2745; ++i) start.set(i, 230);
	for (i = 2749; i <= 2749; ++i) start.set(i, 230);
	for (i = 2768; i <= 2768; ++i) start.set(i, 230);
	for (i = 2784; i <= 2785; ++i) start.set(i, 230);
	for (i = 2821; i <= 2828; ++i) start.set(i, 230);
	for (i = 2831; i <= 2832; ++i) start.set(i, 230);
	for (i = 2835; i <= 2856; ++i) start.set(i, 230);
	for (i = 2858; i <= 2864; ++i) start.set(i, 230);
	for (i = 2866; i <= 2867; ++i) start.set(i, 230);
	for (i = 2869; i <= 2873; ++i) start.set(i, 230);
	for (i = 2877; i <= 2877; ++i) start.set(i, 230);
	for (i = 2908; i <= 2909; ++i) start.set(i, 230);
	for (i = 2911; i <= 2913; ++i) start.set(i, 230);
	for (i = 2929; i <= 2929; ++i) start.set(i, 230);
	for (i = 2947; i <= 2947; ++i) start.set(i, 230);
	for (i = 2949; i <= 2954; ++i) start.set(i, 230);
	for (i = 2958; i <= 2960; ++i) start.set(i, 230);
	for (i = 2962; i <= 2965; ++i) start.set(i, 230);
	for (i = 2969; i <= 2970; ++i) start.set(i, 230);
	for (i = 2972; i <= 2972; ++i) start.set(i, 230);
	for (i = 2974; i <= 2975; ++i) start.set(i, 230);
	for (i = 2979; i <= 2980; ++i) start.set(i, 230);
	for (i = 2984; i <= 2986; ++i) start.set(i, 230);
	for (i = 2990; i <= 2997; ++i) start.set(i, 230);
	for (i = 2999; i <= 3001; ++i) start.set(i, 230);
	for (i = 3077; i <= 3084; ++i) start.set(i, 230);
	for (i = 3086; i <= 3088; ++i) start.set(i, 230);
	for (i = 3090; i <= 3112; ++i) start.set(i, 230);
	for (i = 3114; i <= 3123; ++i) start.set(i, 230);
	for (i = 3125; i <= 3129; ++i) start.set(i, 230);
	for (i = 3168; i <= 3169; ++i) start.set(i, 230);
	for (i = 3205; i <= 3212; ++i) start.set(i, 230);
	for (i = 3214; i <= 3216; ++i) start.set(i, 230);
	for (i = 3218; i <= 3240; ++i) start.set(i, 230);
	for (i = 3242; i <= 3251; ++i) start.set(i, 230);
	for (i = 3253; i <= 3257; ++i) start.set(i, 230);
	for (i = 3261; i <= 3261; ++i) start.set(i, 230);
	for (i = 3294; i <= 3294; ++i) start.set(i, 230);
	for (i = 3296; i <= 3297; ++i) start.set(i, 230);
	for (i = 3333; i <= 3340; ++i) start.set(i, 230);
	for (i = 3342; i <= 3344; ++i) start.set(i, 230);
	for (i = 3346; i <= 3368; ++i) start.set(i, 230);
	for (i = 3370; i <= 3385; ++i) start.set(i, 230);
	for (i = 3424; i <= 3425; ++i) start.set(i, 230);
	for (i = 3461; i <= 3478; ++i) start.set(i, 230);
	for (i = 3482; i <= 3505; ++i) start.set(i, 230);
	for (i = 3507; i <= 3515; ++i) start.set(i, 230);
	for (i = 3517; i <= 3517; ++i) start.set(i, 230);
	for (i = 3520; i <= 3526; ++i) start.set(i, 230);
	for (i = 3585; i <= 3632; ++i) start.set(i, 230);
	for (i = 3634; i <= 3635; ++i) start.set(i, 230);
	for (i = 3648; i <= 3654; ++i) start.set(i, 230);
	for (i = 3713; i <= 3714; ++i) start.set(i, 230);
	for (i = 3716; i <= 3716; ++i) start.set(i, 230);
	for (i = 3719; i <= 3720; ++i) start.set(i, 230);
	for (i = 3722; i <= 3722; ++i) start.set(i, 230);
	for (i = 3725; i <= 3725; ++i) start.set(i, 230);
	for (i = 3732; i <= 3735; ++i) start.set(i, 230);
	for (i = 3737; i <= 3743; ++i) start.set(i, 230);
	for (i = 3745; i <= 3747; ++i) start.set(i, 230);
	for (i = 3749; i <= 3749; ++i) start.set(i, 230);
	for (i = 3751; i <= 3751; ++i) start.set(i, 230);
	for (i = 3754; i <= 3755; ++i) start.set(i, 230);
	for (i = 3757; i <= 3760; ++i) start.set(i, 230);
	for (i = 3762; i <= 3763; ++i) start.set(i, 230);
	for (i = 3773; i <= 3773; ++i) start.set(i, 230);
	for (i = 3776; i <= 3780; ++i) start.set(i, 230);
	for (i = 3782; i <= 3782; ++i) start.set(i, 230);
	for (i = 3804; i <= 3805; ++i) start.set(i, 230);
	for (i = 3840; i <= 3840; ++i) start.set(i, 230);
	for (i = 3904; i <= 3911; ++i) start.set(i, 230);
	for (i = 3913; i <= 3946; ++i) start.set(i, 230);
	for (i = 3976; i <= 3979; ++i) start.set(i, 230);
	for (i = 4096; i <= 4129; ++i) start.set(i, 230);
	for (i = 4131; i <= 4135; ++i) start.set(i, 230);
	for (i = 4137; i <= 4138; ++i) start.set(i, 230);
	for (i = 4176; i <= 4181; ++i) start.set(i, 230);
	for (i = 4256; i <= 4293; ++i) start.set(i, 230);
	for (i = 4304; i <= 4344; ++i) start.set(i, 230);
	for (i = 4352; i <= 4441; ++i) start.set(i, 230);
	for (i = 4447; i <= 4514; ++i) start.set(i, 230);
	for (i = 4520; i <= 4601; ++i) start.set(i, 230);
	for (i = 4608; i <= 4614; ++i) start.set(i, 230);
	for (i = 4616; i <= 4678; ++i) start.set(i, 230);
	for (i = 4680; i <= 4680; ++i) start.set(i, 230);
	for (i = 4682; i <= 4685; ++i) start.set(i, 230);
	for (i = 4688; i <= 4694; ++i) start.set(i, 230);
	for (i = 4696; i <= 4696; ++i) start.set(i, 230);
	for (i = 4698; i <= 4701; ++i) start.set(i, 230);
	for (i = 4704; i <= 4742; ++i) start.set(i, 230);
	for (i = 4744; i <= 4744; ++i) start.set(i, 230);
	for (i = 4746; i <= 4749; ++i) start.set(i, 230);
	for (i = 4752; i <= 4782; ++i) start.set(i, 230);
	for (i = 4784; i <= 4784; ++i) start.set(i, 230);
	for (i = 4786; i <= 4789; ++i) start.set(i, 230);
	for (i = 4792; i <= 4798; ++i) start.set(i, 230);
	for (i = 4800; i <= 4800; ++i) start.set(i, 230);
	for (i = 4802; i <= 4805; ++i) start.set(i, 230);
	for (i = 4808; i <= 4814; ++i) start.set(i, 230);
	for (i = 4816; i <= 4822; ++i) start.set(i, 230);
	for (i = 4824; i <= 4846; ++i) start.set(i, 230);
	for (i = 4848; i <= 4878; ++i) start.set(i, 230);
	for (i = 4880; i <= 4880; ++i) start.set(i, 230);
	for (i = 4882; i <= 4885; ++i) start.set(i, 230);
	for (i = 4888; i <= 4894; ++i) start.set(i, 230);
	for (i = 4896; i <= 4934; ++i) start.set(i, 230);
	for (i = 4936; i <= 4954; ++i) start.set(i, 230);
	for (i = 5024; i <= 5108; ++i) start.set(i, 230);
	for (i = 5121; i <= 5740; ++i) start.set(i, 230);
	for (i = 5743; i <= 5750; ++i) start.set(i, 230);
	for (i = 5761; i <= 5786; ++i) start.set(i, 230);
	for (i = 5792; i <= 5866; ++i) start.set(i, 230);
	for (i = 5870; i <= 5872; ++i) start.set(i, 230);
	for (i = 5888; i <= 5900; ++i) start.set(i, 230);
	for (i = 5902; i <= 5905; ++i) start.set(i, 230);
	for (i = 5920; i <= 5937; ++i) start.set(i, 230);
	for (i = 5952; i <= 5969; ++i) start.set(i, 230);
	for (i = 5984; i <= 5996; ++i) start.set(i, 230);
	for (i = 5998; i <= 6000; ++i) start.set(i, 230);
	for (i = 6016; i <= 6067; ++i) start.set(i, 230);
	for (i = 6103; i <= 6103; ++i) start.set(i, 230);
	for (i = 6108; i <= 6108; ++i) start.set(i, 230);
	for (i = 6176; i <= 6263; ++i) start.set(i, 230);
	for (i = 6272; i <= 6312; ++i) start.set(i, 230);
	for (i = 6400; i <= 6428; ++i) start.set(i, 230);
	for (i = 6480; i <= 6509; ++i) start.set(i, 230);
	for (i = 7424; i <= 7531; ++i) start.set(i, 230);
	for (i = 7680; i <= 7835; ++i) start.set(i, 230);
	for (i = 7840; i <= 7929; ++i) start.set(i, 230);
	for (i = 7936; i <= 7957; ++i) start.set(i, 230);
	for (i = 7960; i <= 7965; ++i) start.set(i, 230);
	for (i = 7968; i <= 8005; ++i) start.set(i, 230);
	for (i = 8008; i <= 8013; ++i) start.set(i, 230);
	for (i = 8016; i <= 8023; ++i) start.set(i, 230);
	for (i = 8025; i <= 8025; ++i) start.set(i, 230);
	for (i = 8027; i <= 8027; ++i) start.set(i, 230);
	for (i = 8029; i <= 8029; ++i) start.set(i, 230);
	for (i = 8031; i <= 8061; ++i) start.set(i, 230);
	for (i = 8064; i <= 8116; ++i) start.set(i, 230);
	for (i = 8118; i <= 8124; ++i) start.set(i, 230);
	for (i = 8126; i <= 8126; ++i) start.set(i, 230);
	for (i = 8130; i <= 8132; ++i) start.set(i, 230);
	for (i = 8134; i <= 8140; ++i) start.set(i, 230);
	for (i = 8144; i <= 8147; ++i) start.set(i, 230);
	for (i = 8150; i <= 8155; ++i) start.set(i, 230);
	for (i = 8160; i <= 8172; ++i) start.set(i, 230);
	for (i = 8178; i <= 8180; ++i) start.set(i, 230);
	for (i = 8182; i <= 8188; ++i) start.set(i, 230);
	for (i = 8305; i <= 8305; ++i) start.set(i, 230);
	for (i = 8319; i <= 8319; ++i) start.set(i, 230);
	for (i = 8450; i <= 8450; ++i) start.set(i, 230);
	for (i = 8455; i <= 8455; ++i) start.set(i, 230);
	for (i = 8458; i <= 8467; ++i) start.set(i, 230);
	for (i = 8469; i <= 8469; ++i) start.set(i, 230);
	for (i = 8473; i <= 8477; ++i) start.set(i, 230);
	for (i = 8484; i <= 8484; ++i) start.set(i, 230);
	for (i = 8486; i <= 8486; ++i) start.set(i, 230);
	for (i = 8488; i <= 8488; ++i) start.set(i, 230);
	for (i = 8490; i <= 8493; ++i) start.set(i, 230);
	for (i = 8495; i <= 8497; ++i) start.set(i, 230);
	for (i = 8499; i <= 8505; ++i) start.set(i, 230);
	for (i = 8509; i <= 8511; ++i) start.set(i, 230);
	for (i = 8517; i <= 8521; ++i) start.set(i, 230);
	for (i = 8544; i <= 8579; ++i) start.set(i, 230);
	for (i = 12293; i <= 12295; ++i) start.set(i, 230);
	for (i = 12321; i <= 12329; ++i) start.set(i, 230);
	for (i = 12337; i <= 12341; ++i) start.set(i, 230);
	for (i = 12344; i <= 12348; ++i) start.set(i, 230);
	for (i = 12353; i <= 12438; ++i) start.set(i, 230);
	for (i = 12445; i <= 12447; ++i) start.set(i, 230);
	for (i = 12449; i <= 12538; ++i) start.set(i, 230);
	for (i = 12540; i <= 12543; ++i) start.set(i, 230);
	for (i = 12549; i <= 12588; ++i) start.set(i, 230);
	for (i = 12593; i <= 12686; ++i) start.set(i, 230);
	for (i = 12704; i <= 12727; ++i) start.set(i, 230);
	for (i = 12784; i <= 12799; ++i) start.set(i, 230);
	for (i = 13312; i <= 13312; ++i) start.set(i, 230);
	for (i = 19893; i <= 19893; ++i) start.set(i, 230);
	for (i = 19968; i <= 42124; ++i) start.set(i, 230);
	for (i = 44032; i <= 44032; ++i) start.set(i, 230);
	for (i = 55203; i <= 55203; ++i) start.set(i, 230);
	for (i = 64256; i <= 64262; ++i) start.set(i, 230);
	for (i = 64275; i <= 64279; ++i) start.set(i, 230);
	for (i = 64285; i <= 64285; ++i) start.set(i, 230);
	for (i = 64287; i <= 64296; ++i) start.set(i, 230);
	for (i = 64298; i <= 64310; ++i) start.set(i, 230);
	for (i = 64312; i <= 64316; ++i) start.set(i, 230);
	for (i = 64318; i <= 64318; ++i) start.set(i, 230);
	for (i = 64320; i <= 64321; ++i) start.set(i, 230);
	for (i = 64323; i <= 64324; ++i) start.set(i, 230);
	for (i = 64326; i <= 64433; ++i) start.set(i, 230);
	for (i = 64467; i <= 64829; ++i) start.set(i, 230);
	for (i = 64848; i <= 64911; ++i) start.set(i, 230);
	for (i = 64914; i <= 64967; ++i) start.set(i, 230);
	for (i = 65008; i <= 65019; ++i) start.set(i, 230);
	for (i = 65136; i <= 65140; ++i) start.set(i, 230);
	for (i = 65142; i <= 65276; ++i) start.set(i, 230);
	for (i = 65313; i <= 65338; ++i) start.set(i, 230);
	for (i = 65345; i <= 65370; ++i) start.set(i, 230);
	for (i = 65382; i <= 65470; ++i) start.set(i, 230);
	for (i = 65474; i <= 65479; ++i) start.set(i, 230);
	for (i = 65482; i <= 65487; ++i) start.set(i, 230);
	for (i = 65490; i <= 65495; ++i) start.set(i, 230);
	for (i = 65498; i <= 65500; ++i) start.set(i, 230);
	start.set(44, 2);
	start.set(46, 231);
	start.set(40, 4);
	start.set(41, 6);
	...
	keywords.set(L"event", 55);
	keywords.set(L"function", 58);
	keywords.set(L"in", 59);
	keywords.set(L"is", 60);
	keywords.set(L"loop", 61);
	keywords.set(L"method", 62);
	keywords.set(L"public", 63);
	keywords.set(L"select", 64);
	keywords.set(L"shared", 65);
	keywords.set(L"sub", 66);
	keywords.set(L"try", 67);
	keywords.set(L"unit", 68);
...
Token* Scanner::NextToken() {
	...
	switch (state) {
		...
		case 1:
			...
			else if (ch == 13) {AddCh(); goto case_248;}
			else {t->kind = 1; break;}
		case 2:
			case_2:
			recEnd = pos; recKind = 2;
			if (ch == 10 || ch == 133 || (ch >= 8232 && ch <= 8233)) {AddCh(); goto case_3;}
			else if (ch == 13) {AddCh(); goto case_249;}
		...
		case 9:
			...
			else if (ch == 13) {AddCh(); goto case_251;}
		...
		case 12:
			case_12:
			if (ch == 9 || ch == L' ') {AddCh(); goto case_12;}
			else if (ch == L'}') {apx++; AddCh(); goto case_254;}
			else {goto case_0;}
		case 13:
			case_13:
			{
		...
		case 130:
			...
			else if (ch == 9 || ch == L' ') {apx++; AddCh(); goto case_256;}
			else {goto case_0;}
		case 131:
			case_131:
		...
		case 160:
			case_160:
			if (ch == L'l') {AddCh(); goto case_161;}
			else {goto case_0;}
		case 161:
			case_161:
			if (ch == L'e') {AddCh(); goto case_162;}
			else {goto case_0;}
		case 162:
			case_162:
			if (ch == L'c') {AddCh(); goto case_163;}
			else {goto case_0;}
		case 163:
			case_163:
			if (ch == L't') {AddCh(); goto case_164;}
			else {goto case_0;}
		case 164:
			case_164:
			if (ch == 10 || ch == 13 || ch == 39 || ch == L'/' || ch == 133 || (ch >= 8232 && ch <= 8233)) {apx++; AddCh(); goto case_165;}
			else if (ch == 9 || ch == L' ') {apx++; AddCh(); goto case_164;}
			else {goto case_0;}
		case 165:
			case_165:
			{
		...
		case 167:
			case_167:
			if (ch == L'u') {AddCh(); goto case_168;}
			else {goto case_0;}
		case 168:
			case_168:
			if (ch == L'c') {AddCh(); goto case_169;}
			else {goto case_0;}
		case 169:
			case_169:
			if (ch == L't') {AddCh(); goto case_170;}
			else {goto case_0;}
		case 170:
			case_170:
			if (ch == 10 || ch == 13 || ch == 39 || ch == L'/' || ch == 133 || (ch >= 8232 && ch <= 8233)) {apx++; AddCh(); goto case_171;}
			else if (ch == 9 || ch == L' ') {apx++; AddCh(); goto case_170;}
			else {goto case_0;}
		case 171:
			case_171:
			{
		...
		case 175:
			case_175:
			if (ch == L'i') {AddCh(); goto case_176;}
			else {goto case_0;}
		case 176:
			case_176:
			if (ch == L't') {AddCh(); goto case_177;}
			else {goto case_0;}
		case 177:
			case_177:
		...
		case 181:
			case_181:
			if (ch == 10 || ch == 13 || ch == 39 || ch == L'/' || ch == 133 || (ch >= 8232 && ch <= 8233)) {apx++; AddCh(); goto case_186;}
			else if (ch == 9 || ch == L' ') {apx++; AddCh(); goto case_181;}
			else {goto case_0;}
		case 182:
			case_182:
			if (ch == L'h') {AddCh(); goto case_183;}
			else {goto case_0;}
		case 183:
			case_183:
		...
		case 196:
			case_196:
			if (ch == L't') {AddCh(); goto case_197;}
			else {goto case_0;}
		case 197:
			case_197:
			if (ch == 10 || ch == 13 || ch == 133 || (ch >= 8232 && ch <= 8233)) {AddCh(); goto case_198;}
			else if (ch <= 9 || (ch >= 11 && ch <= 12) || (ch >= 14 && ch <= 132) || (ch >= 134 && ch <= 8231) || (ch >= 8234 && ch <= 65535)) {AddCh(); goto case_197;}
			else {goto case_0;}
		case 198:
			case_198:
		...
		case 201:
			case_201:
			if (ch == 10 || ch == 13 || ch == 133 || (ch >= 8232 && ch <= 8233)) {AddCh(); goto case_202;}
			else if (ch <= 9 || (ch >= 11 && ch <= 12) || (ch >= 14 && ch <= 132) || (ch >= 134 && ch <= 8231) || (ch >= 8234 && ch <= 65535)) {AddCh(); goto case_201;}
			else {goto case_0;}
		case 202:
			case_202:
		...
		case 210:
			case_210:
			if (ch == 9 || ch == L' ') {AddCh(); goto case_210;}
			else if (ch == L'i') {AddCh(); goto case_211;}
			else {goto case_0;}
		case 211:
			case_211:
			if (ch == L'f') {AddCh(); goto case_212;}
			else {goto case_0;}
		case 212:
			case_212:
		...
		case 216:
			case_216:
			if (ch == L'o') {AddCh(); goto case_217;}
			else {goto case_0;}
		case 217:
			case_217:
			if (ch == L'r') {AddCh(); goto case_218;}
			else {goto case_0;}
		case 218:
			case_218:
		...
		case 220:
			case_220:
			if (ch == L'r') {AddCh(); goto case_221;}
			else {goto case_0;}
		case 221:
			case_221:
			if (ch == L'n') {AddCh(); goto case_222;}
			else {goto case_0;}
		case 222:
			case_222:
		...
		case 223:
			...
			else if (ch == 9 || ch == L' ') {AddCh(); goto case_223;}
			else if (ch == 39) {AddCh(); goto case_225;}
			else {goto case_0;}
		case 224:
			case_224:
		...
		case 225:
			case_225:
			if (ch == 10 || ch == 13 || ch == 133 || (ch >= 8232 && ch <= 8233)) {AddCh(); goto case_224;}
			else if (ch <= 9 || (ch >= 11 && ch <= 12) || (ch >= 14 && ch <= 132) || (ch >= 134 && ch <= 8231) || (ch >= 8234 && ch <= 65535)) {AddCh(); goto case_225;}
			else {goto case_0;}
		case 226:
			case_226:
			{t->kind = 156; break;}
		...
		case 229:
			...
			if ((ch >= L'0' && ch <= L'9')) {AddCh(); goto case_229;}
			else if (ch == L'_') {AddCh(); goto case_257;}
			else if (ch == L'e') {apx++; AddCh(); goto case_258;}
			else if (ch == L'.') {AddCh(); goto case_259;}
			else {t->kind = 15; break;}
		case 230:
			case_230:
			recEnd = pos; recKind = 26;
			if ((ch >= L'0' && ch <= L'9') || (ch >= L'a' && ch <= L'z') || ch == 170 || ch == 173 || ch == 181 || ch == 186 || (ch >= 192 && ch <= 214) || (ch >= 216 && ch <= 246) || (ch >= 248 && ch <= 566) || (ch >= 592 && ch <= 705) || (ch >= 710 && ch <= 721) || (ch >= 736 && ch <= 740) || ch == 750 || (ch >= 768 && ch <= 855) || (ch >= 861 && ch <= 879) || ch == 890 || ch == 902 || (ch >= 904 && ch <= 906) || ch == 908 || (ch >= 910 && ch <= 929) || (ch >= 931 && ch <= 974) || (ch >= 976 && ch <= 1013) || (ch >= 1015 && ch <= 1019) || (ch >= 1024 && ch <= 1153) || (ch >= 1155 && ch <= 1158) || (ch >= 1162 && ch <= 1230) || (ch >= 1232 && ch <= 1269) || (ch >= 1272 && ch <= 1273) || (ch >= 1280 && ch <= 1295) || (ch >= 1329 && ch <= 1366) || ch == 1369 || (ch >= 1377 && ch <= 1415) || (ch >= 1425 && ch <= 1441) || (ch >= 1443 && ch <= 1465) || (ch >= 1467 && ch <= 1469) || ch == 1471 || (ch >= 1473 && ch <= 1474) || ch == 1476 || (ch >= 1488 && ch <= 1514) || (ch >= 1520 && ch <= 1522) || (ch >= 1536 && ch <= 1539) || (ch >= 1552 && ch <= 1557) || (ch >= 1569 && ch <= 1594) || (ch >= 1600 && ch <= 1624) || (ch >= 1632 && ch <= 1641) || (ch >= 1646 && ch <= 1747) || (ch >= 1749 && ch <= 1757) || (ch >= 1759 && ch <= 1768) || (ch >= 1770 && ch <= 1788) || ch == 1791 || (ch >= 1807 && ch <= 1866) || (ch >= 1869 && ch <= 1871) || (ch >= 1920 && ch <= 1969) || (ch >= 2305 && ch <= 2361) || (ch >= 2364 && ch <= 2381) || (ch >= 2384 && ch <= 2388) || (ch >= 2392 && ch <= 2403) || (ch >= 2406 && ch <= 2415) || (ch >= 2433 && ch <= 2435) || (ch >= 2437 && ch <= 2444) || (ch >= 2447 && ch <= 2448) || (ch >= 2451 && ch <= 2472) || (ch >= 2474 && ch <= 2480) || ch == 2482 || (ch >= 2486 && ch <= 2489) || (ch >= 2492 && ch <= 2500) || (ch >= 2503 && ch <= 2504) || (ch >= 2507 && ch <= 2509) || ch == 2519 || (ch >= 2524 && ch <= 2525) || (ch >= 2527 && ch <= 2531) || (ch >= 2534 && ch <= 2545) || (ch >= 2561 && ch <= 2563) || (ch >= 2565 && ch <= 2570) || (ch >= 2575 && ch <= 2576) || (ch >= 2579 && ch <= 2600) || (ch >= 2602 && ch <= 2608) || (ch >= 2610 && ch <= 2611) || (ch >= 2613 && ch <= 2614) || (ch >= 2616 && ch <= 2617) || ch == 2620 || (ch >= 2622 && ch <= 2626) || (ch >= 2631 && ch <= 2632) || (ch >= 2635 && ch <= 2637) || (ch >= 2649 && ch <= 2652) || ch == 2654 || (ch >= 2662 && ch <= 2676) || (ch >= 2689 && ch <= 2691) || (ch >= 2693 && ch <= 2701) || (ch >= 2703 && ch <= 2705) || (ch >= 2707 && ch <= 2728) || (ch >= 2730 && ch <= 2736) || (ch >= 2738 && ch <= 2739) || (ch >= 2741 && ch <= 2745) || (ch >= 2748 && ch <= 2757) || (ch >= 2759 && ch <= 2761) || (ch >= 2763 && ch <= 2765) || ch == 2768 || (ch >= 2784 && ch <= 2787) || (ch >= 2790 && ch <= 2799) || (ch >= 2817 && ch <= 2819) || (ch >= 2821 && ch <= 2828) || (ch >= 2831 && ch <= 2832) || (ch >= 2835 && ch <= 2856) || (ch >= 2858 && ch <= 2864) || (ch >= 2866 && ch <= 2867) || (ch >= 2869 && ch <= 2873) || (ch >= 2876 && ch <= 2883) || (ch >= 2887 && ch <= 2888) || (ch >= 2891 && ch <= 2893) || (ch >= 2902 && ch <= 2903) || (ch >= 2908 && ch <= 2909) || (ch >= 2911 && ch <= 2913) || (ch >= 2918 && ch <= 2927) || ch == 2929 || (ch >= 2946 && ch <= 2947) || (ch >= 2949 && ch <= 2954) || (ch >= 2958 && ch <= 2960) || (ch >= 2962 && ch <= 2965) || (ch >= 2969 && ch <= 2970) || ch == 2972 || (ch >= 2974 && ch <= 2975) || (ch >= 2979 && ch <= 2980) || (ch >= 2984 && ch <= 2986) || (ch >= 2990 && ch <= 2997) || (ch >= 2999 && ch <= 3001) || (ch >= 3006 && ch <= 3010) || (ch >= 3014 && ch <= 3016) || (ch >= 3018 && ch <= 3021) || ch == 3031 || (ch >= 3047 && ch <= 3055) || (ch >= 3073 && ch <= 3075) || (ch >= 3077 && ch <= 3084) || (ch >= 3086 && ch <= 3088) || (ch >= 3090 && ch <= 3112) || (ch >= 3114 && ch <= 3123) || (ch >= 3125 && ch <= 3129) || (ch >= 3134 && ch <= 3140) || (ch >= 3142 && ch <= 3144) || (ch >= 3146 && ch <= 3149) || (ch >= 3157 && ch <= 3158) || (ch >= 3168 && ch <= 3169) || (ch >= 3174 && ch <= 3183) || (ch >= 3202 && ch <= 3203) || (ch >= 3205 && ch <= 3212) || (ch >= 3214 && ch <= 3216) || (ch >= 3218 && ch <= 3240) || (ch >= 3242 && ch <= 3251) || (ch >= 3253 && ch <= 3257) || (ch >= 3260 && ch <= 3268) || (ch >= 3270 && ch <= 3272) || (ch >= 3274 && ch <= 3277) || (ch >= 3285 && ch <= 3286) || ch == 3294 || (ch >= 3296 && ch <= 3297) || (ch >= 3302 && ch <= 3311) || (ch >= 3330 && ch <= 3331) || (ch >= 3333 && ch <= 3340) || (ch >= 3342 && ch <= 3344) || (ch >= 3346 && ch <= 3368) || (ch >= 3370 && ch <= 3385) || (ch >= 3390 && ch <= 3395) || (ch >= 3398 && ch <= 3400) || (ch >= 3402 && ch <= 3405) || ch == 3415 || (ch >= 3424 && ch <= 3425) || (ch >= 3430 && ch <= 3439) || (ch >= 3458 && ch <= 3459) || (ch >= 3461 && ch <= 3478) || (ch >= 3482 && ch <= 3505) || (ch >= 3507 && ch <= 3515) || ch == 3517 || (ch >= 3520 && ch <= 3526) || ch == 3530 || (ch >= 3535 && ch <= 3540) || ch == 3542 || (ch >= 3544 && ch <= 3551) || (ch >= 3570 && ch <= 3571) || (ch >= 3585 && ch <= 3642) || (ch >= 3648 && ch <= 3662) || (ch >= 3664 && ch <= 3673) || (ch >= 3713 && ch <= 3714) || ch == 3716 || (ch >= 3719 && ch <= 3720) || ch == 3722 || ch == 3725 || (ch >= 3732 && ch <= 3735) || (ch >= 3737 && ch <= 3743) || (ch >= 3745 && ch <= 3747) || ch == 3749 || ch == 3751 || (ch >= 3754 && ch <= 3755) || (ch >= 3757 && ch <= 3769) || (ch >= 3771 && ch <= 3773) || (ch >= 3776 && ch <= 3780) || ch == 3782 || (ch >= 3784 && ch <= 3789) || (ch >= 3792 && ch <= 3801) || (ch >= 3804 && ch <= 3805) || ch == 3840 || (ch >= 3864 && ch <= 3865) || (ch >= 3872 && ch <= 3881) || ch == 3893 || ch == 3895 || ch == 3897 || (ch >= 3902 && ch <= 3911) || (ch >= 3913 && ch <= 3946) || (ch >= 3953 && ch <= 3972) || (ch >= 3974 && ch <= 3979) || (ch >= 3984 && ch <= 3991) || (ch >= 3993 && ch <= 4028) || ch == 4038 || (ch >= 4096 && ch <= 4129) || (ch >= 4131 && ch <= 4135) || (ch >= 4137 && ch <= 4138) || (ch >= 4140 && ch <= 4146) || (ch >= 4150 && ch <= 4153) || (ch >= 4160 && ch <= 4169) || (ch >= 4176 && ch <= 4185) || (ch >= 4256 && ch <= 4293) || (ch >= 4304 && ch <= 4344) || (ch >= 4352 && ch <= 4441) || (ch >= 4447 && ch <= 4514) || (ch >= 4520 && ch <= 4601) || (ch >= 4608 && ch <= 4614) || (ch >= 4616 && ch <= 4678) || ch == 4680 || (ch >= 4682 && ch <= 4685) || (ch >= 4688 && ch <= 4694) || ch == 4696 || (ch >= 4698 && ch <= 4701) || (ch >= 4704 && ch <= 4742) || ch == 4744 || (ch >= 4746 && ch <= 4749) || (ch >= 4752 && ch <= 4782) || ch == 4784 || (ch >= 4786 && ch <= 4789) || (ch >= 4792 && ch <= 4798) || ch == 4800 || (ch >= 4802 && ch <= 4805) || (ch >= 4808 && ch <= 4814) || (ch >= 4816 && ch <= 4822) || (ch >= 4824 && ch <= 4846) || (ch >= 4848 && ch <= 4878) || ch == 4880 || (ch >= 4882 && ch <= 4885) || (ch >= 4888 && ch <= 4894) || (ch >= 4896 && ch <= 4934) || (ch >= 4936 && ch <= 4954) || (ch >= 4969 && ch <= 4977) || (ch >= 5024 && ch <= 5108) || (ch >= 5121 && ch <= 5740) || (ch >= 5743 && ch <= 5750) || (ch >= 5761 && ch <= 5786) || (ch >= 5792 && ch <= 5866) || (ch >= 5870 && ch <= 5872) || (ch >= 5888 && ch <= 5900) || (ch >= 5902 && ch <= 5908) || (ch >= 5920 && ch <= 5940) || (ch >= 5952 && ch <= 5971) || (ch >= 5984 && ch <= 5996) || (ch >= 5998 && ch <= 6000) || (ch >= 6002 && ch <= 6003) || (ch >= 6016 && ch <= 6099) || ch == 6103 || (ch >= 6108 && ch <= 6109) || (ch >= 6112 && ch <= 6121) || (ch >= 6155 && ch <= 6157) || (ch >= 6160 && ch <= 6169) || (ch >= 6176 && ch <= 6263) || (ch >= 6272 && ch <= 6313) || (ch >= 6400 && ch <= 6428) || (ch >= 6432 && ch <= 6443) || (ch >= 6448 && ch <= 6459) || (ch >= 6470 && ch <= 6509) || (ch >= 7424 && ch <= 7531) || (ch >= 7680 && ch <= 7835) || (ch >= 7840 && ch <= 7929) || (ch >= 7936 && ch <= 7957) || (ch >= 7960 && ch <= 7965) || (ch >= 7968 && ch <= 8005) || (ch >= 8008 && ch <= 8013) || (ch >= 8016 && ch <= 8023) || ch == 8025 || ch == 8027 || ch == 8029 || (ch >= 8031 && ch <= 8061) || (ch >= 8064 && ch <= 8116) || (ch >= 8118 && ch <= 8124) || ch == 8126 || (ch >= 8130 && ch <= 8132) || (ch >= 8134 && ch <= 8140) || (ch >= 8144 && ch <= 8147) || (ch >= 8150 && ch <= 8155) || (ch >= 8160 && ch <= 8172) || (ch >= 8178 && ch <= 8180) || (ch >= 8182 && ch <= 8188) || (ch >= 8203 && ch <= 8207) || (ch >= 8234 && ch <= 8238) || (ch >= 8288 && ch <= 8291) || (ch >= 8298 && ch <= 8303) || ch == 8305 || ch == 8319 || (ch >= 8400 && ch <= 8412) || ch == 8417 || (ch >= 8421 && ch <= 8426) || ch == 8450 || ch == 8455 || (ch >= 8458 && ch <= 8467) || ch == 8469 || (ch >= 8473 && ch <= 8477) || ch == 8484 || ch == 8486 || ch == 8488 || (ch >= 8490 && ch <= 8493) || (ch >= 8495 && ch <= 8497) || (ch >= 8499 && ch <= 8505) || (ch >= 8509 && ch <= 8511) || (ch >= 8517 && ch <= 8521) || (ch >= 8544 && ch <= 8579) || (ch >= 12293 && ch <= 12295) || (ch >= 12321 && ch <= 12335) || (ch >= 12337 && ch <= 12341) || (ch >= 12344 && ch <= 12348) || (ch >= 12353 && ch <= 12438) || (ch >= 12441 && ch <= 12442) || (ch >= 12445 && ch <= 12447) || (ch >= 12449 && ch <= 12538) || (ch >= 12540 && ch <= 12543) || (ch >= 12549 && ch <= 12588) || (ch >= 12593 && ch <= 12686) || (ch >= 12704 && ch <= 12727) || (ch >= 12784 && ch <= 12799) || ch == 13312 || ch == 19893 || (ch >= 19968 && ch <= 42124) || ch == 44032 || ch == 55203 || (ch >= 64256 && ch <= 64262) || (ch >= 64275 && ch <= 64279) || (ch >= 64285 && ch <= 64296) || (ch >= 64298 && ch <= 64310) || (ch >= 64312 && ch <= 64316) || ch == 64318 || (ch >= 64320 && ch <= 64321) || (ch >= 64323 && ch <= 64324) || (ch >= 64326 && ch <= 64433) || (ch >= 64467 && ch <= 64829) || (ch >= 64848 && ch <= 64911) || (ch >= 64914 && ch <= 64967) || (ch >= 65008 && ch <= 65019) || (ch >= 65056 && ch <= 65059) || (ch >= 65136 && ch <= 65140) || (ch >= 65142 && ch <= 65276) || ch == 65279 || (ch >= 65296 && ch <= 65305) || (ch >= 65313 && ch <= 65338) || (ch >= 65345 && ch <= 65370) || (ch >= 65382 && ch <= 65470) || (ch >= 65474 && ch <= 65479) || (ch >= 65482 && ch <= 65487) || (ch >= 65490 && ch <= 65495) || (ch >= 65498 && ch <= 65500) || (ch >= 65529 && ch <= 65531)) {AddCh(); goto case_230;}
			else if (ch == L'_' || (ch >= 8255 && ch <= 8256) || ch == 8276 || ch == 12539 || (ch >= 65075 && ch <= 65076) || (ch >= 65101 && ch <= 65103) || ch == 65343 || ch == 65381) {AddCh(); goto case_260;}
			else if (ch == L'#') {apx++; AddCh(); goto case_261;}
		...
		case 232:
			...
			if (ch == 9 || ch == L' ') {AddCh(); goto case_252;}
			else if (ch == 10 || ch == 133 || (ch >= 8232 && ch <= 8233)) {AddCh(); goto case_11;}
			else if (ch == 13) {AddCh(); goto case_253;}
		...
		case 233:
			...
			if (ch == L'=') {AddCh(); goto case_17;}
			else if (ch == L'b') {apx++; AddCh(); goto case_262;}
			else if (ch == L'h') {apx++; AddCh(); goto case_263;}
			else if (ch == L'o') {apx++; AddCh(); goto case_264;}
			else {t->kind = 12; break;}
		case 234:
			recEnd = pos; recKind = 26;
			if ((ch >= L'0' && ch <= L'9') || (ch >= L'a' && ch <= L'm') || (ch >= L'o' && ch <= L'z') || ch == 170 || ch == 173 || ch == 181 || ch == 186 || (ch >= 192 && ch <= 214) || (ch >= 216 && ch <= 246) || (ch >= 248 && ch <= 566) || (ch >= 592 && ch <= 705) || (ch >= 710 && ch <= 721) || (ch >= 736 && ch <= 740) || ch == 750 || (ch >= 768 && ch <= 855) || (ch >= 861 && ch <= 879) || ch == 890 || ch == 902 || (ch >= 904 && ch <= 906) || ch == 908 || (ch >= 910 && ch <= 929) || (ch >= 931 && ch <= 974) || (ch >= 976 && ch <= 1013) || (ch >= 1015 && ch <= 1019) || (ch >= 1024 && ch <= 1153) || (ch >= 1155 && ch <= 1158) || (ch >= 1162 && ch <= 1230) || (ch >= 1232 && ch <= 1269) || (ch >= 1272 && ch <= 1273) || (ch >= 1280 && ch <= 1295) || (ch >= 1329 && ch <= 1366) || ch == 1369 || (ch >= 1377 && ch <= 1415) || (ch >= 1425 && ch <= 1441) || (ch >= 1443 && ch <= 1465) || (ch >= 1467 && ch <= 1469) || ch == 1471 || (ch >= 1473 && ch <= 1474) || ch == 1476 || (ch >= 1488 && ch <= 1514) || (ch >= 1520 && ch <= 1522) || (ch >= 1536 && ch <= 1539) || (ch >= 1552 && ch <= 1557) || (ch >= 1569 && ch <= 1594) || (ch >= 1600 && ch <= 1624) || (ch >= 1632 && ch <= 1641) || (ch >= 1646 && ch <= 1747) || (ch >= 1749 && ch <= 1757) || (ch >= 1759 && ch <= 1768) || (ch >= 1770 && ch <= 1788) || ch == 1791 || (ch >= 1807 && ch <= 1866) || (ch >= 1869 && ch <= 1871) || (ch >= 1920 && ch <= 1969) || (ch >= 2305 && ch <= 2361) || (ch >= 2364 && ch <= 2381) || (ch >= 2384 && ch <= 2388) || (ch >= 2392 && ch <= 2403) || (ch >= 2406 && ch <= 2415) || (ch >= 2433 && ch <= 2435) || (ch >= 2437 && ch <= 2444) || (ch >= 2447 && ch <= 2448) || (ch >= 2451 && ch <= 2472) || (ch >= 2474 && ch <= 2480) || ch == 2482 || (ch >= 2486 && ch <= 2489) || (ch >= 2492 && ch <= 2500) || (ch >= 2503 && ch <= 2504) || (ch >= 2507 && ch <= 2509) || ch == 2519 || (ch >= 2524 && ch <= 2525) || (ch >= 2527 && ch <= 2531) || (ch >= 2534 && ch <= 2545) || (ch >= 2561 && ch <= 2563) || (ch >= 2565 && ch <= 2570) || (ch >= 2575 && ch <= 2576) || (ch >= 2579 && ch <= 2600) || (ch >= 2602 && ch <= 2608) || (ch >= 2610 && ch <= 2611) || (ch >= 2613 && ch <= 2614) || (ch >= 2616 && ch <= 2617) || ch == 2620 || (ch >= 2622 && ch <= 2626) || (ch >= 2631 && ch <= 2632) || (ch >= 2635 && ch <= 2637) || (ch >= 2649 && ch <= 2652) || ch == 2654 || (ch >= 2662 && ch <= 2676) || (ch >= 2689 && ch <= 2691) || (ch >= 2693 && ch <= 2701) || (ch >= 2703 && ch <= 2705) || (ch >= 2707 && ch <= 2728) || (ch >= 2730 && ch <= 2736) || (ch >= 2738 && ch <= 2739) || (ch >= 2741 && ch <= 2745) || (ch >= 2748 && ch <= 2757) || (ch >= 2759 && ch <= 2761) || (ch >= 2763 && ch <= 2765) || ch == 2768 || (ch >= 2784 && ch <= 2787) || (ch >= 2790 && ch <= 2799) || (ch >= 2817 && ch <= 2819) || (ch >= 2821 && ch <= 2828) || (ch >= 2831 && ch <= 2832) || (ch >= 2835 && ch <= 2856) || (ch >= 2858 && ch <= 2864) || (ch >= 2866 && ch <= 2867) || (ch >= 2869 && ch <= 2873) || (ch >= 2876 && ch <= 2883) || (ch >= 2887 && ch <= 2888) || (ch >= 2891 && ch <= 2893) || (ch >= 2902 && ch <= 2903) || (ch >= 2908 && ch <= 2909) || (ch >= 2911 && ch <= 2913) || (ch >= 2918 && ch <= 2927) || ch == 2929 || (ch >= 2946 && ch <= 2947) || (ch >= 2949 && ch <= 2954) || (ch >= 2958 && ch <= 2960) || (ch >= 2962 && ch <= 2965) || (ch >= 2969 && ch <= 2970) || ch == 2972 || (ch >= 2974 && ch <= 2975) || (ch >= 2979 && ch <= 2980) || (ch >= 2984 && ch <= 2986) || (ch >= 2990 && ch <= 2997) || (ch >= 2999 && ch <= 3001) || (ch >= 3006 && ch <= 3010) || (ch >= 3014 && ch <= 3016) || (ch >= 3018 && ch <= 3021) || ch == 3031 || (ch >= 3047 && ch <= 3055) || (ch >= 3073 && ch <= 3075) || (ch >= 3077 && ch <= 3084) || (ch >= 3086 && ch <= 3088) || (ch >= 3090 && ch <= 3112) || (ch >= 3114 && ch <= 3123) || (ch >= 3125 && ch <= 3129) || (ch >= 3134 && ch <= 3140) || (ch >= 3142 && ch <= 3144) || (ch >= 3146 && ch <= 3149) || (ch >= 3157 && ch <= 3158) || (ch >= 3168 && ch <= 3169) || (ch >= 3174 && ch <= 3183) || (ch >= 3202 && ch <= 3203) || (ch >= 3205 && ch <= 3212) || (ch >= 3214 && ch <= 3216) || (ch >= 3218 && ch <= 3240) || (ch >= 3242 && ch <= 3251) || (ch >= 3253 && ch <= 3257) || (ch >= 3260 && ch <= 3268) || (ch >= 3270 && ch <= 3272) || (ch >= 3274 && ch <= 3277) || (ch >= 3285 && ch <= 3286) || ch == 3294 || (ch >= 3296 && ch <= 3297) || (ch >= 3302 && ch <= 3311) || (ch >= 3330 && ch <= 3331) || (ch >= 3333 && ch <= 3340) || (ch >= 3342 && ch <= 3344) || (ch >= 3346 && ch <= 3368) || (ch >= 3370 && ch <= 3385) || (ch >= 3390 && ch <= 3395) || (ch >= 3398 && ch <= 3400) || (ch >= 3402 && ch <= 3405) || ch == 3415 || (ch >= 3424 && ch <= 3425) || (ch >= 3430 && ch <= 3439) || (ch >= 3458 && ch <= 3459) || (ch >= 3461 && ch <= 3478) || (ch >= 3482 && ch <= 3505) || (ch >= 3507 && ch <= 3515) || ch == 3517 || (ch >= 3520 && ch <= 3526) || ch == 3530 || (ch >= 3535 && ch <= 3540) || ch == 3542 || (ch >= 3544 && ch <= 3551) || (ch >= 3570 && ch <= 3571) || (ch >= 3585 && ch <= 3642) || (ch >= 3648 && ch <= 3662) || (ch >= 3664 && ch <= 3673) || (ch >= 3713 && ch <= 3714) || ch == 3716 || (ch >= 3719 && ch <= 3720) || ch == 3722 || ch == 3725 || (ch >= 3732 && ch <= 3735) || (ch >= 3737 && ch <= 3743) || (ch >= 3745 && ch <= 3747) || ch == 3749 || ch == 3751 || (ch >= 3754 && ch <= 3755) || (ch >= 3757 && ch <= 3769) || (ch >= 3771 && ch <= 3773) || (ch >= 3776 && ch <= 3780) || ch == 3782 || (ch >= 3784 && ch <= 3789) || (ch >= 3792 && ch <= 3801) || (ch >= 3804 && ch <= 3805) || ch == 3840 || (ch >= 3864 && ch <= 3865) || (ch >= 3872 && ch <= 3881) || ch == 3893 || ch == 3895 || ch == 3897 || (ch >= 3902 && ch <= 3911) || (ch >= 3913 && ch <= 3946) || (ch >= 3953 && ch <= 3972) || (ch >= 3974 && ch <= 3979) || (ch >= 3984 && ch <= 3991) || (ch >= 3993 && ch <= 4028) || ch == 4038 || (ch >= 4096 && ch <= 4129) || (ch >= 4131 && ch <= 4135) || (ch >= 4137 && ch <= 4138) || (ch >= 4140 && ch <= 4146) || (ch >= 4150 && ch <= 4153) || (ch >= 4160 && ch <= 4169) || (ch >= 4176 && ch <= 4185) || (ch >= 4256 && ch <= 4293) || (ch >= 4304 && ch <= 4344) || (ch >= 4352 && ch <= 4441) || (ch >= 4447 && ch <= 4514) || (ch >= 4520 && ch <= 4601) || (ch >= 4608 && ch <= 4614) || (ch >= 4616 && ch <= 4678) || ch == 4680 || (ch >= 4682 && ch <= 4685) || (ch >= 4688 && ch <= 4694) || ch == 4696 || (ch >= 4698 && ch <= 4701) || (ch >= 4704 && ch <= 4742) || ch == 4744 || (ch >= 4746 && ch <= 4749) || (ch >= 4752 && ch <= 4782) || ch == 4784 || (ch >= 4786 && ch <= 4789) || (ch >= 4792 && ch <= 4798) || ch == 4800 || (ch >= 4802 && ch <= 4805) || (ch >= 4808 && ch <= 4814) || (ch >= 4816 && ch <= 4822) || (ch >= 4824 && ch <= 4846) || (ch >= 4848 && ch <= 4878) || ch == 4880 || (ch >= 4882 && ch <= 4885) || (ch >= 4888 && ch <= 4894) || (ch >= 4896 && ch <= 4934) || (ch >= 4936 && ch <= 4954) || (ch >= 4969 && ch <= 4977) || (ch >= 5024 && ch <= 5108) || (ch >= 5121 && ch <= 5740) || (ch >= 5743 && ch <= 5750) || (ch >= 5761 && ch <= 5786) || (ch >= 5792 && ch <= 5866) || (ch >= 5870 && ch <= 5872) || (ch >= 5888 && ch <= 5900) || (ch >= 5902 && ch <= 5908) || (ch >= 5920 && ch <= 5940) || (ch >= 5952 && ch <= 5971) || (ch >= 5984 && ch <= 5996) || (ch >= 5998 && ch <= 6000) || (ch >= 6002 && ch <= 6003) || (ch >= 6016 && ch <= 6099) || ch == 6103 || (ch >= 6108 && ch <= 6109) || (ch >= 6112 && ch <= 6121) || (ch >= 6155 && ch <= 6157) || (ch >= 6160 && ch <= 6169) || (ch >= 6176 && ch <= 6263) || (ch >= 6272 && ch <= 6313) || (ch >= 6400 && ch <= 6428) || (ch >= 6432 && ch <= 6443) || (ch >= 6448 && ch <= 6459) || (ch >= 6470 && ch <= 6509) || (ch >= 7424 && ch <= 7531) || (ch >= 7680 && ch <= 7835) || (ch >= 7840 && ch <= 7929) || (ch >= 7936 && ch <= 7957) || (ch >= 7960 && ch <= 7965) || (ch >= 7968 && ch <= 8005) || (ch >= 8008 && ch <= 8013) || (ch >= 8016 && ch <= 8023) || ch == 8025 || ch == 8027 || ch == 8029 || (ch >= 8031 && ch <= 8061) || (ch >= 8064 && ch <= 8116) || (ch >= 8118 && ch <= 8124) || ch == 8126 || (ch >= 8130 && ch <= 8132) || (ch >= 8134 && ch <= 8140) || (ch >= 8144 && ch <= 8147) || (ch >= 8150 && ch <= 8155) || (ch >= 8160 && ch <= 8172) || (ch >= 8178 && ch <= 8180) || (ch >= 8182 && ch <= 8188) || (ch >= 8203 && ch <= 8207) || (ch >= 8234 && ch <= 8238) || (ch >= 8288 && ch <= 8291) || (ch >= 8298 && ch <= 8303) || ch == 8305 || ch == 8319 || (ch >= 8400 && ch <= 8412) || ch == 8417 || (ch >= 8421 && ch <= 8426) || ch == 8450 || ch == 8455 || (ch >= 8458 && ch <= 8467) || ch == 8469 || (ch >= 8473 && ch <= 8477) || ch == 8484 || ch == 8486 || ch == 8488 || (ch >= 8490 && ch <= 8493) || (ch >= 8495 && ch <= 8497) || (ch >= 8499 && ch <= 8505) || (ch >= 8509 && ch <= 8511) || (ch >= 8517 && ch <= 8521) || (ch >= 8544 && ch <= 8579) || (ch >= 12293 && ch <= 12295) || (ch >= 12321 && ch <= 12335) || (ch >= 12337 && ch <= 12341) || (ch >= 12344 && ch <= 12348) || (ch >= 12353 && ch <= 12438) || (ch >= 12441 && ch <= 12442) || (ch >= 12445 && ch <= 12447) || (ch >= 12449 && ch <= 12538) || (ch >= 12540 && ch <= 12543) || (ch >= 12549 && ch <= 12588) || (ch >= 12593 && ch <= 12686) || (ch >= 12704 && ch <= 12727) || (ch >= 12784 && ch <= 12799) || ch == 13312 || ch == 19893 || (ch >= 19968 && ch <= 42124) || ch == 44032 || ch == 55203 || (ch >= 64256 && ch <= 64262) || (ch >= 64275 && ch <= 64279) || (ch >= 64285 && ch <= 64296) || (ch >= 64298 && ch <= 64310) || (ch >= 64312 && ch <= 64316) || ch == 64318 || (ch >= 64320 && ch <= 64321) || (ch >= 64323 && ch <= 64324) || (ch >= 64326 && ch <= 64433) || (ch >= 64467 && ch <= 64829) || (ch >= 64848 && ch <= 64911) || (ch >= 64914 && ch <= 64967) || (ch >= 65008 && ch <= 65019) || (ch >= 65056 && ch <= 65059) || (ch >= 65136 && ch <= 65140) || (ch >= 65142 && ch <= 65276) || ch == 65279 || (ch >= 65296 && ch <= 65305) || (ch >= 65313 && ch <= 65338) || (ch >= 65345 && ch <= 65370) || (ch >= 65382 && ch <= 65470) || (ch >= 65474 && ch <= 65479) || (ch >= 65482 && ch <= 65487) || (ch >= 65490 && ch <= 65495) || (ch >= 65498 && ch <= 65500) || (ch >= 65529 && ch <= 65531)) {AddCh(); goto case_230;}
			else if (ch == L'_' || (ch >= 8255 && ch <= 8256) || ch == 8276 || ch == 12539 || (ch >= 65075 && ch <= 65076) || (ch >= 65101 && ch <= 65103) || ch == 65343 || ch == 65381) {AddCh(); goto case_260;}
			else if (ch == L'n') {AddCh(); goto case_265;}
			else if (ch == L'#') {apx++; AddCh(); goto case_261;}
			else if (ch == L'%') {AddCh(); goto case_85;}
			else if (ch == L'$') {AddCh(); goto case_86;}
			else {t->kind = 26; wchar_t *literal = coco_string_create_lower(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		case 235:
			...
			else if (ch == L'r') {AddCh(); goto case_266;}
			else if (ch == L'#') {apx++; AddCh(); goto case_261;}
			else if (ch == L'%') {AddCh(); goto case_85;}
			else if (ch == L'$') {AddCh(); goto case_86;}
			else {t->kind = 26; wchar_t *literal = coco_string_create_lower(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		case 236:
			...
			else if (ch == L'o') {AddCh(); goto case_267;}
			else if (ch == L'#') {apx++; AddCh(); goto case_261;}
			else if (ch == L'%') {AddCh(); goto case_85;}
			else if (ch == L'$') {AddCh(); goto case_86;}
			else {t->kind = 26; wchar_t *literal = coco_string_create_lower(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		case 237:
			...
			else if (ch == L'h') {AddCh(); goto case_268;}
			else if (ch == L'#') {apx++; AddCh(); goto case_261;}
			else if (ch == L'%') {AddCh(); goto case_85;}
			else if (ch == L'$') {AddCh(); goto case_86;}
			else {t->kind = 26; wchar_t *literal = coco_string_create_lower(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		case 238:
			...
			else if (ch == L'o') {AddCh(); goto case_269;}
			else if (ch == L'#') {apx++; AddCh(); goto case_261;}
			else if (ch == L'%') {AddCh(); goto case_85;}
			else if (ch == L'$') {AddCh(); goto case_86;}
			else {t->kind = 26; wchar_t *literal = coco_string_create_lower(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		case 239:
			...
			else if (ch == L'e') {AddCh(); goto case_270;}
			else if (ch == L'#') {apx++; AddCh(); goto case_261;}
			else if (ch == L'%') {AddCh(); goto case_85;}
			else if (ch == L'$') {AddCh(); goto case_86;}
			else {t->kind = 26; wchar_t *literal = coco_string_create_lower(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		case 240:
			if ((ch >= L'0' && ch <= L'9')) {AddCh(); goto case_40;}
			else if (ch == L'c') {AddCh(); goto case_193;}
			else if (ch == L'i') {AddCh(); goto case_200;}
			else if (ch == L'e') {AddCh(); goto case_271;}
			else if (ch == L'w') {AddCh(); goto case_219;}
			else {goto case_0;}
		case 241:
			recEnd = pos; recKind = 22;
			if ((ch >= L' ' && ch <= 132) || (ch >= 134 && ch <= 8231) || (ch >= 8234 && ch <= 65535)) {AddCh(); goto case_272;}
			else {t->kind = 22; break;}
		case 242:
			case_242:
			recEnd = pos; recKind = 24;
			if ((ch >= L' ' && ch <= L'!') || (ch >= L'#' && ch <= 132) || (ch >= 134 && ch <= 8231) || (ch >= 8234 && ch <= 65535)) {AddCh(); goto case_242;}
			else if (ch == L'"') {AddCh(); goto case_273;}
			else {t->kind = 24; break;}
		case 243:
			if (ch == 10 || ch == 13 || ch == 133 || (ch >= 8232 && ch <= 8233)) {AddCh(); goto case_224;}
			else if (ch == 9 || ch == L' ') {AddCh(); goto case_223;}
			else if (ch == L'"') {AddCh(); goto case_242;}
			else if (ch == 39) {AddCh(); goto case_225;}
			else {goto case_0;}
		case 244:
			recEnd = pos; recKind = 26;
		...
		case 246:
			...
			else if (ch == L'e') {AddCh(); goto case_276;}
			else {t->kind = 26; wchar_t *literal = coco_string_create_lower(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		case 247:
			recEnd = pos; recKind = 26;
			if ((ch >= L'0' && ch <= L'9') || (ch >= L'a' && ch <= L'n') || (ch >= L'p' && ch <= L'z') || ch == 170 || ch == 173 || ch == 181 || ch == 186 || (ch >= 192 && ch <= 214) || (ch >= 216 && ch <= 246) || (ch >= 248 && ch <= 566) || (ch >= 592 && ch <= 705) || (ch >= 710 && ch <= 721) || (ch >= 736 && ch <= 740) || ch == 750 || (ch >= 768 && ch <= 855) || (ch >= 861 && ch <= 879) || ch == 890 || ch == 902 || (ch >= 904 && ch <= 906) || ch == 908 || (ch >= 910 && ch <= 929) || (ch >= 931 && ch <= 974) || (ch >= 976 && ch <= 1013) || (ch >= 1015 && ch <= 1019) || (ch >= 1024 && ch <= 1153) || (ch >= 1155 && ch <= 1158) || (ch >= 1162 && ch <= 1230) || (ch >= 1232 && ch <= 1269) || (ch >= 1272 && ch <= 1273) || (ch >= 1280 && ch <= 1295) || (ch >= 1329 && ch <= 1366) || ch == 1369 || (ch >= 1377 && ch <= 1415) || (ch >= 1425 && ch <= 1441) || (ch >= 1443 && ch <= 1465) || (ch >= 1467 && ch <= 1469) || ch == 1471 || (ch >= 1473 && ch <= 1474) || ch == 1476 || (ch >= 1488 && ch <= 1514) || (ch >= 1520 && ch <= 1522) || (ch >= 1536 && ch <= 1539) || (ch >= 1552 && ch <= 1557) || (ch >= 1569 && ch <= 1594) || (ch >= 1600 && ch <= 1624) || (ch >= 1632 && ch <= 1641) || (ch >= 1646 && ch <= 1747) || (ch >= 1749 && ch <= 1757) || (ch >= 1759 && ch <= 1768) || (ch >= 1770 && ch <= 1788) || ch == 1791 || (ch >= 1807 && ch <= 1866) || (ch >= 1869 && ch <= 1871) || (ch >= 1920 && ch <= 1969) || (ch >= 2305 && ch <= 2361) || (ch >= 2364 && ch <= 2381) || (ch >= 2384 && ch <= 2388) || (ch >= 2392 && ch <= 2403) || (ch >= 2406 && ch <= 2415) || (ch >= 2433 && ch <= 2435) || (ch >= 2437 && ch <= 2444) || (ch >= 2447 && ch <= 2448) || (ch >= 2451 && ch <= 2472) || (ch >= 2474 && ch <= 2480) || ch == 2482 || (ch >= 2486 && ch <= 2489) || (ch >= 2492 && ch <= 2500) || (ch >= 2503 && ch <= 2504) || (ch >= 2507 && ch <= 2509) || ch == 2519 || (ch >= 2524 && ch <= 2525) || (ch >= 2527 && ch <= 2531) || (ch >= 2534 && ch <= 2545) || (ch >= 2561 && ch <= 2563) || (ch >= 2565 && ch <= 2570) || (ch >= 2575 && ch <= 2576) || (ch >= 2579 && ch <= 2600) || (ch >= 2602 && ch <= 2608) || (ch >= 2610 && ch <= 2611) || (ch >= 2613 && ch <= 2614) || (ch >= 2616 && ch <= 2617) || ch == 2620 || (ch >= 2622 && ch <= 2626) || (ch >= 2631 && ch <= 2632) || (ch >= 2635 && ch <= 2637) || (ch >= 2649 && ch <= 2652) || ch == 2654 || (ch >= 2662 && ch <= 2676) || (ch >= 2689 && ch <= 2691) || (ch >= 2693 && ch <= 2701) || (ch >= 2703 && ch <= 2705) || (ch >= 2707 && ch <= 2728) || (ch >= 2730 && ch <= 2736) || (ch >= 2738 && ch <= 2739) || (ch >= 2741 && ch <= 2745) || (ch >= 2748 && ch <= 2757) || (ch >= 2759 && ch <= 2761) || (ch >= 2763 && ch <= 2765) || ch == 2768 || (ch >= 2784 && ch <= 2787) || (ch >= 2790 && ch <= 2799) || (ch >= 2817 && ch <= 2819) || (ch >= 2821 && ch <= 2828) || (ch >= 2831 && ch <= 2832) || (ch >= 2835 && ch <= 2856) || (ch >= 2858 && ch <= 2864) || (ch >= 2866 && ch <= 2867) || (ch >= 2869 && ch <= 2873) || (ch >= 2876 && ch <= 2883) || (ch >= 2887 && ch <= 2888) || (ch >= 2891 && ch <= 2893) || (ch >= 2902 && ch <= 2903) || (ch >= 2908 && ch <= 2909) || (ch >= 2911 && ch <= 2913) || (ch >= 2918 && ch <= 2927) || ch == 2929 || (ch >= 2946 && ch <= 2947) || (ch >= 2949 && ch <= 2954) || (ch >= 2958 && ch <= 2960) || (ch >= 2962 && ch <= 2965) || (ch >= 2969 && ch <= 2970) || ch == 2972 || (ch >= 2974 && ch <= 2975) || (ch >= 2979 && ch <= 2980) || (ch >= 2984 && ch <= 2986) || (ch >= 2990 && ch <= 2997) || (ch >= 2999 && ch <= 3001) || (ch >= 3006 && ch <= 3010) || (ch >= 3014 && ch <= 3016) || (ch >= 3018 && ch <= 3021) || ch == 3031 || (ch >= 3047 && ch <= 3055) || (ch >= 3073 && ch <= 3075) || (ch >= 3077 && ch <= 3084) || (ch >= 3086 && ch <= 3088) || (ch >= 3090 && ch <= 3112) || (ch >= 3114 && ch <= 3123) || (ch >= 3125 && ch <= 3129) || (ch >= 3134 && ch <= 3140) || (ch >= 3142 && ch <= 3144) || (ch >= 3146 && ch <= 3149) || (ch >= 3157 && ch <= 3158) || (ch >= 3168 && ch <= 3169) || (ch >= 3174 && ch <= 3183) || (ch >= 3202 && ch <= 3203) || (ch >= 3205 && ch <= 3212) || (ch >= 3214 && ch <= 3216) || (ch >= 3218 && ch <= 3240) || (ch >= 3242 && ch <= 3251) || (ch >= 3253 && ch <= 3257) || (ch >= 3260 && ch <= 3268) || (ch >= 3270 && ch <= 3272) || (ch >= 3274 && ch <= 3277) || (ch >= 3285 && ch <= 3286) || ch == 3294 || (ch >= 3296 && ch <= 3297) || (ch >= 3302 && ch <= 3311) || (ch >= 3330 && ch <= 3331) || (ch >= 3333 && ch <= 3340) || (ch >= 3342 && ch <= 3344) || (ch >= 3346 && ch <= 3368) || (ch >= 3370 && ch <= 3385) || (ch >= 3390 && ch <= 3395) || (ch >= 3398 && ch <= 3400) || (ch >= 3402 && ch <= 3405) || ch == 3415 || (ch >= 3424 && ch <= 3425) || (ch >= 3430 && ch <= 3439) || (ch >= 3458 && ch <= 3459) || (ch >= 3461 && ch <= 3478) || (ch >= 3482 && ch <= 3505) || (ch >= 3507 && ch <= 3515) || ch == 3517 || (ch >= 3520 && ch <= 3526) || ch == 3530 || (ch >= 3535 && ch <= 3540) || ch == 3542 || (ch >= 3544 && ch <= 3551) || (ch >= 3570 && ch <= 3571) || (ch >= 3585 && ch <= 3642) || (ch >= 3648 && ch <= 3662) || (ch >= 3664 && ch <= 3673) || (ch >= 3713 && ch <= 3714) || ch == 3716 || (ch >= 3719 && ch <= 3720) || ch == 3722 || ch == 3725 || (ch >= 3732 && ch <= 3735) || (ch >= 3737 && ch <= 3743) || (ch >= 3745 && ch <= 3747) || ch == 3749 || ch == 3751 || (ch >= 3754 && ch <= 3755) || (ch >= 3757 && ch <= 3769) || (ch >= 3771 && ch <= 3773) || (ch >= 3776 && ch <= 3780) || ch == 3782 || (ch >= 3784 && ch <= 3789) || (ch >= 3792 && ch <= 3801) || (ch >= 3804 && ch <= 3805) || ch == 3840 || (ch >= 3864 && ch <= 3865) || (ch >= 3872 && ch <= 3881) || ch == 3893 || ch == 3895 || ch == 3897 || (ch >= 3902 && ch <= 3911) || (ch >= 3913 && ch <= 3946) || (ch >= 3953 && ch <= 3972) || (ch >= 3974 && ch <= 3979) || (ch >= 3984 && ch <= 3991) || (ch >= 3993 && ch <= 4028) || ch == 4038 || (ch >= 4096 && ch <= 4129) || (ch >= 4131 && ch <= 4135) || (ch >= 4137 && ch <= 4138) || (ch >= 4140 && ch <= 4146) || (ch >= 4150 && ch <= 4153) || (ch >= 4160 && ch <= 4169) || (ch >= 4176 && ch <= 4185) || (ch >= 4256 && ch <= 4293) || (ch >= 4304 && ch <= 4344) || (ch >= 4352 && ch <= 4441) || (ch >= 4447 && ch <= 4514) || (ch >= 4520 && ch <= 4601) || (ch >= 4608 && ch <= 4614) || (ch >= 4616 && ch <= 4678) || ch == 4680 || (ch >= 4682 && ch <= 4685) || (ch >= 4688 && ch <= 4694) || ch == 4696 || (ch >= 4698 && ch <= 4701) || (ch >= 4704 && ch <= 4742) || ch == 4744 || (ch >= 4746 && ch <= 4749) || (ch >= 4752 && ch <= 4782) || ch == 4784 || (ch >= 4786 && ch <= 4789) || (ch >= 4792 && ch <= 4798) || ch == 4800 || (ch >= 4802 && ch <= 4805) || (ch >= 4808 && ch <= 4814) || (ch >= 4816 && ch <= 4822) || (ch >= 4824 && ch <= 4846) || (ch >= 4848 && ch <= 4878) || ch == 4880 || (ch >= 4882 && ch <= 4885) || (ch >= 4888 && ch <= 4894) || (ch >= 4896 && ch <= 4934) || (ch >= 4936 && ch <= 4954) || (ch >= 4969 && ch <= 4977) || (ch >= 5024 && ch <= 5108) || (ch >= 5121 && ch <= 5740) || (ch >= 5743 && ch <= 5750) || (ch >= 5761 && ch <= 5786) || (ch >= 5792 && ch <= 5866) || (ch >= 5870 && ch <= 5872) || (ch >= 5888 && ch <= 5900) || (ch >= 5902 && ch <= 5908) || (ch >= 5920 && ch <= 5940) || (ch >= 5952 && ch <= 5971) || (ch >= 5984 && ch <= 5996) || (ch >= 5998 && ch <= 6000) || (ch >= 6002 && ch <= 6003) || (ch >= 6016 && ch <= 6099) || ch == 6103 || (ch >= 6108 && ch <= 6109) || (ch >= 6112 && ch <= 6121) || (ch >= 6155 && ch <= 6157) || (ch >= 6160 && ch <= 6169) || (ch >= 6176 && ch <= 6263) || (ch >= 6272 && ch <= 6313) || (ch >= 6400 && ch <= 6428) || (ch >= 6432 && ch <= 6443) || (ch >= 6448 && ch <= 6459) || (ch >= 6470 && ch <= 6509) || (ch >= 7424 && ch <= 7531) || (ch >= 7680 && ch <= 7835) || (ch >= 7840 && ch <= 7929) || (ch >= 7936 && ch <= 7957) || (ch >= 7960 && ch <= 7965) || (ch >= 7968 && ch <= 8005) || (ch >= 8008 && ch <= 8013) || (ch >= 8016 && ch <= 8023) || ch == 8025 || ch == 8027 || ch == 8029 || (ch >= 8031 && ch <= 8061) || (ch >= 8064 && ch <= 8116) || (ch >= 8118 && ch <= 8124) || ch == 8126 || (ch >= 8130 && ch <= 8132) || (ch >= 8134 && ch <= 8140) || (ch >= 8144 && ch <= 8147) || (ch >= 8150 && ch <= 8155) || (ch >= 8160 && ch <= 8172) || (ch >= 8178 && ch <= 8180) || (ch >= 8182 && ch <= 8188) || (ch >= 8203 && ch <= 8207) || (ch >= 8234 && ch <= 8238) || (ch >= 8288 && ch <= 8291) || (ch >= 8298 && ch <= 8303) || ch == 8305 || ch == 8319 || (ch >= 8400 && ch <= 8412) || ch == 8417 || (ch >= 8421 && ch <= 8426) || ch == 8450 || ch == 8455 || (ch >= 8458 && ch <= 8467) || ch == 8469 || (ch >= 8473 && ch <= 8477) || ch == 8484 || ch == 8486 || ch == 8488 || (ch >= 8490 && ch <= 8493) || (ch >= 8495 && ch <= 8497) || (ch >= 8499 && ch <= 8505) || (ch >= 8509 && ch <= 8511) || (ch >= 8517 && ch <= 8521) || (ch >= 8544 && ch <= 8579) || (ch >= 12293 && ch <= 12295) || (ch >= 12321 && ch <= 12335) || (ch >= 12337 && ch <= 12341) || (ch >= 12344 && ch <= 12348) || (ch >= 12353 && ch <= 12438) || (ch >= 12441 && ch <= 12442) || (ch >= 12445 && ch <= 12447) || (ch >= 12449 && ch <= 12538) || (ch >= 12540 && ch <= 12543) || (ch >= 12549 && ch <= 12588) || (ch >= 12593 && ch <= 12686) || (ch >= 12704 && ch <= 12727) || (ch >= 12784 && ch <= 12799) || ch == 13312 || ch == 19893 || (ch >= 19968 && ch <= 42124) || ch == 44032 || ch == 55203 || (ch >= 64256 && ch <= 64262) || (ch >= 64275 && ch <= 64279) || (ch >= 64285 && ch <= 64296) || (ch >= 64298 && ch <= 64310) || (ch >= 64312 && ch <= 64316) || ch == 64318 || (ch >= 64320 && ch <= 64321) || (ch >= 64323 && ch <= 64324) || (ch >= 64326 && ch <= 64433) || (ch >= 64467 && ch <= 64829) || (ch >= 64848 && ch <= 64911) || (ch >= 64914 && ch <= 64967) || (ch >= 65008 && ch <= 65019) || (ch >= 65056 && ch <= 65059) || (ch >= 65136 && ch <= 65140) || (ch >= 65142 && ch <= 65276) || ch == 65279 || (ch >= 65296 && ch <= 65305) || (ch >= 65313 && ch <= 65338) || (ch >= 65345 && ch <= 65370) || (ch >= 65382 && ch <= 65470) || (ch >= 65474 && ch <= 65479) || (ch >= 65482 && ch <= 65487) || (ch >= 65490 && ch <= 65495) || (ch >= 65498 && ch <= 65500) || (ch >= 65529 && ch <= 65531)) {AddCh(); goto case_230;}
		...
		case 252:
			...
			else if (ch == L'}') {apx++; AddCh(); goto case_278;}
			else {goto case_0;}
		case 253:
			case_253:
			if (ch == 9 || ch == L' ') {AddCh(); goto case_12;}
		...
		case 257:
			case_257:
			if ((ch >= L'0' && ch <= L'9')) {AddCh(); goto case_279;}
			else {goto case_0;}
		case 258:
			case_258:
		...
		case 259:
			case_259:
			if ((ch >= L'0' && ch <= L'9')) {AddCh(); goto case_280;}
			else {goto case_0;}
		case 260:
			case_260:
			if ((ch >= L'0' && ch <= L'9') || (ch >= L'a' && ch <= L'z') || ch == 170 || ch == 173 || ch == 181 || ch == 186 || (ch >= 192 && ch <= 214) || (ch >= 216 && ch <= 246) || (ch >= 248 && ch <= 566) || (ch >= 592 && ch <= 705) || (ch >= 710 && ch <= 721) || (ch >= 736 && ch <= 740) || ch == 750 || (ch >= 768 && ch <= 855) || (ch >= 861 && ch <= 879) || ch == 890 || ch == 902 || (ch >= 904 && ch <= 906) || ch == 908 || (ch >= 910 && ch <= 929) || (ch >= 931 && ch <= 974) || (ch >= 976 && ch <= 1013) || (ch >= 1015 && ch <= 1019) || (ch >= 1024 && ch <= 1153) || (ch >= 1155 && ch <= 1158) || (ch >= 1162 && ch <= 1230) || (ch >= 1232 && ch <= 1269) || (ch >= 1272 && ch <= 1273) || (ch >= 1280 && ch <= 1295) || (ch >= 1329 && ch <= 1366) || ch == 1369 || (ch >= 1377 && ch <= 1415) || (ch >= 1425 && ch <= 1441) || (ch >= 1443 && ch <= 1465) || (ch >= 1467 && ch <= 1469) || ch == 1471 || (ch >= 1473 && ch <= 1474) || ch == 1476 || (ch >= 1488 && ch <= 1514) || (ch >= 1520 && ch <= 1522) || (ch >= 1536 && ch <= 1539) || (ch >= 1552 && ch <= 1557) || (ch >= 1569 && ch <= 1594) || (ch >= 1600 && ch <= 1624) || (ch >= 1632 && ch <= 1641) || (ch >= 1646 && ch <= 1747) || (ch >= 1749 && ch <= 1757) || (ch >= 1759 && ch <= 1768) || (ch >= 1770 && ch <= 1788) || ch == 1791 || (ch >= 1807 && ch <= 1866) || (ch >= 1869 && ch <= 1871) || (ch >= 1920 && ch <= 1969) || (ch >= 2305 && ch <= 2361) || (ch >= 2364 && ch <= 2381) || (ch >= 2384 && ch <= 2388) || (ch >= 2392 && ch <= 2403) || (ch >= 2406 && ch <= 2415) || (ch >= 2433 && ch <= 2435) || (ch >= 2437 && ch <= 2444) || (ch >= 2447 && ch <= 2448) || (ch >= 2451 && ch <= 2472) || (ch >= 2474 && ch <= 2480) || ch == 2482 || (ch >= 2486 && ch <= 2489) || (ch >= 2492 && ch <= 2500) || (ch >= 2503 && ch <= 2504) || (ch >= 2507 && ch <= 2509) || ch == 2519 || (ch >= 2524 && ch <= 2525) || (ch >= 2527 && ch <= 2531) || (ch >= 2534 && ch <= 2545) || (ch >= 2561 && ch <= 2563) || (ch >= 2565 && ch <= 2570) || (ch >= 2575 && ch <= 2576) || (ch >= 2579 && ch <= 2600) || (ch >= 2602 && ch <= 2608) || (ch >= 2610 && ch <= 2611) || (ch >= 2613 && ch <= 2614) || (ch >= 2616 && ch <= 2617) || ch == 2620 || (ch >= 2622 && ch <= 2626) || (ch >= 2631 && ch <= 2632) || (ch >= 2635 && ch <= 2637) || (ch >= 2649 && ch <= 2652) || ch == 2654 || (ch >= 2662 && ch <= 2676) || (ch >= 2689 && ch <= 2691) || (ch >= 2693 && ch <= 2701) || (ch >= 2703 && ch <= 2705) || (ch >= 2707 && ch <= 2728) || (ch >= 2730 && ch <= 2736) || (ch >= 2738 && ch <= 2739) || (ch >= 2741 && ch <= 2745) || (ch >= 2748 && ch <= 2757) || (ch >= 2759 && ch <= 2761) || (ch >= 2763 && ch <= 2765) || ch == 2768 || (ch >= 2784 && ch <= 2787) || (ch >= 2790 && ch <= 2799) || (ch >= 2817 && ch <= 2819) || (ch >= 2821 && ch <= 2828) || (ch >= 2831 && ch <= 2832) || (ch >= 2835 && ch <= 2856) || (ch >= 2858 && ch <= 2864) || (ch >= 2866 && ch <= 2867) || (ch >= 2869 && ch <= 2873) || (ch >= 2876 && ch <= 2883) || (ch >= 2887 && ch <= 2888) || (ch >= 2891 && ch <= 2893) || (ch >= 2902 && ch <= 2903) || (ch >= 2908 && ch <= 2909) || (ch >= 2911 && ch <= 2913) || (ch >= 2918 && ch <= 2927) || ch == 2929 || (ch >= 2946 && ch <= 2947) || (ch >= 2949 && ch <= 2954) || (ch >= 2958 && ch <= 2960) || (ch >= 2962 && ch <= 2965) || (ch >= 2969 && ch <= 2970) || ch == 2972 || (ch >= 2974 && ch <= 2975) || (ch >= 2979 && ch <= 2980) || (ch >= 2984 && ch <= 2986) || (ch >= 2990 && ch <= 2997) || (ch >= 2999 && ch <= 3001) || (ch >= 3006 && ch <= 3010) || (ch >= 3014 && ch <= 3016) || (ch >= 3018 && ch <= 3021) || ch == 3031 || (ch >= 3047 && ch <= 3055) || (ch >= 3073 && ch <= 3075) || (ch >= 3077 && ch <= 3084) || (ch >= 3086 && ch <= 3088) || (ch >= 3090 && ch <= 3112) || (ch >= 3114 && ch <= 3123) || (ch >= 3125 && ch <= 3129) || (ch >= 3134 && ch <= 3140) || (ch >= 3142 && ch <= 3144) || (ch >= 3146 && ch <= 3149) || (ch >= 3157 && ch <= 3158) || (ch >= 3168 && ch <= 3169) || (ch >= 3174 && ch <= 3183) || (ch >= 3202 && ch <= 3203) || (ch >= 3205 && ch <= 3212) || (ch >= 3214 && ch <= 3216) || (ch >= 3218 && ch <= 3240) || (ch >= 3242 && ch <= 3251) || (ch >= 3253 && ch <= 3257) || (ch >= 3260 && ch <= 3268) || (ch >= 3270 && ch <= 3272) || (ch >= 3274 && ch <= 3277) || (ch >= 3285 && ch <= 3286) || ch == 3294 || (ch >= 3296 && ch <= 3297) || (ch >= 3302 && ch <= 3311) || (ch >= 3330 && ch <= 3331) || (ch >= 3333 && ch <= 3340) || (ch >= 3342 && ch <= 3344) || (ch >= 3346 && ch <= 3368) || (ch >= 3370 && ch <= 3385) || (ch >= 3390 && ch <= 3395) || (ch >= 3398 && ch <= 3400) || (ch >= 3402 && ch <= 3405) || ch == 3415 || (ch >= 3424 && ch <= 3425) || (ch >= 3430 && ch <= 3439) || (ch >= 3458 && ch <= 3459) || (ch >= 3461 && ch <= 3478) || (ch >= 3482 && ch <= 3505) || (ch >= 3507 && ch <= 3515) || ch == 3517 || (ch >= 3520 && ch <= 3526) || ch == 3530 || (ch >= 3535 && ch <= 3540) || ch == 3542 || (ch >= 3544 && ch <= 3551) || (ch >= 3570 && ch <= 3571) || (ch >= 3585 && ch <= 3642) || (ch >= 3648 && ch <= 3662) || (ch >= 3664 && ch <= 3673) || (ch >= 3713 && ch <= 3714) || ch == 3716 || (ch >= 3719 && ch <= 3720) || ch == 3722 || ch == 3725 || (ch >= 3732 && ch <= 3735) || (ch >= 3737 && ch <= 3743) || (ch >= 3745 && ch <= 3747) || ch == 3749 || ch == 3751 || (ch >= 3754 && ch <= 3755) || (ch >= 3757 && ch <= 3769) || (ch >= 3771 && ch <= 3773) || (ch >= 3776 && ch <= 3780) || ch == 3782 || (ch >= 3784 && ch <= 3789) || (ch >= 3792 && ch <= 3801) || (ch >= 3804 && ch <= 3805) || ch == 3840 || (ch >= 3864 && ch <= 3865) || (ch >= 3872 && ch <= 3881) || ch == 3893 || ch == 3895 || ch == 3897 || (ch >= 3902 && ch <= 3911) || (ch >= 3913 && ch <= 3946) || (ch >= 3953 && ch <= 3972) || (ch >= 3974 && ch <= 3979) || (ch >= 3984 && ch <= 3991) || (ch >= 3993 && ch <= 4028) || ch == 4038 || (ch >= 4096 && ch <= 4129) || (ch >= 4131 && ch <= 4135) || (ch >= 4137 && ch <= 4138) || (ch >= 4140 && ch <= 4146) || (ch >= 4150 && ch <= 4153) || (ch >= 4160 && ch <= 4169) || (ch >= 4176 && ch <= 4185) || (ch >= 4256 && ch <= 4293) || (ch >= 4304 && ch <= 4344) || (ch >= 4352 && ch <= 4441) || (ch >= 4447 && ch <= 4514) || (ch >= 4520 && ch <= 4601) || (ch >= 4608 && ch <= 4614) || (ch >= 4616 && ch <= 4678) || ch == 4680 || (ch >= 4682 && ch <= 4685) || (ch >= 4688 && ch <= 4694) || ch == 4696 || (ch >= 4698 && ch <= 4701) || (ch >= 4704 && ch <= 4742) || ch == 4744 || (ch >= 4746 && ch <= 4749) || (ch >= 4752 && ch <= 4782) || ch == 4784 || (ch >= 4786 && ch <= 4789) || (ch >= 4792 && ch <= 4798) || ch == 4800 || (ch >= 4802 && ch <= 4805) || (ch >= 4808 && ch <= 4814) || (ch >= 4816 && ch <= 4822) || (ch >= 4824 && ch <= 4846) || (ch >= 4848 && ch <= 4878) || ch == 4880 || (ch >= 4882 && ch <= 4885) || (ch >= 4888 && ch <= 4894) || (ch >= 4896 && ch <= 4934) || (ch >= 4936 && ch <= 4954) || (ch >= 4969 && ch <= 4977) || (ch >= 5024 && ch <= 5108) || (ch >= 5121 && ch <= 5740) || (ch >= 5743 && ch <= 5750) || (ch >= 5761 && ch <= 5786) || (ch >= 5792 && ch <= 5866) || (ch >= 5870 && ch <= 5872) || (ch >= 5888 && ch <= 5900) || (ch >= 5902 && ch <= 5908) || (ch >= 5920 && ch <= 5940) || (ch >= 5952 && ch <= 5971) || (ch >= 5984 && ch <= 5996) || (ch >= 5998 && ch <= 6000) || (ch >= 6002 && ch <= 6003) || (ch >= 6016 && ch <= 6099) || ch == 6103 || (ch >= 6108 && ch <= 6109) || (ch >= 6112 && ch <= 6121) || (ch >= 6155 && ch <= 6157) || (ch >= 6160 && ch <= 6169) || (ch >= 6176 && ch <= 6263) || (ch >= 6272 && ch <= 6313) || (ch >= 6400 && ch <= 6428) || (ch >= 6432 && ch <= 6443) || (ch >= 6448 && ch <= 6459) || (ch >= 6470 && ch <= 6509) || (ch >= 7424 && ch <= 7531) || (ch >= 7680 && ch <= 7835) || (ch >= 7840 && ch <= 7929) || (ch >= 7936 && ch <= 7957) || (ch >= 7960 && ch <= 7965) || (ch >= 7968 && ch <= 8005) || (ch >= 8008 && ch <= 8013) || (ch >= 8016 && ch <= 8023) || ch == 8025 || ch == 8027 || ch == 8029 || (ch >= 8031 && ch <= 8061) || (ch >= 8064 && ch <= 8116) || (ch >= 8118 && ch <= 8124) || ch == 8126 || (ch >= 8130 && ch <= 8132) || (ch >= 8134 && ch <= 8140) || (ch >= 8144 && ch <= 8147) || (ch >= 8150 && ch <= 8155) || (ch >= 8160 && ch <= 8172) || (ch >= 8178 && ch <= 8180) || (ch >= 8182 && ch <= 8188) || (ch >= 8203 && ch <= 8207) || (ch >= 8234 && ch <= 8238) || (ch >= 8288 && ch <= 8291) || (ch >= 8298 && ch <= 8303) || ch == 8305 || ch == 8319 || (ch >= 8400 && ch <= 8412) || ch == 8417 || (ch >= 8421 && ch <= 8426) || ch == 8450 || ch == 8455 || (ch >= 8458 && ch <= 8467) || ch == 8469 || (ch >= 8473 && ch <= 8477) || ch == 8484 || ch == 8486 || ch == 8488 || (ch >= 8490 && ch <= 8493) || (ch >= 8495 && ch <= 8497) || (ch >= 8499 && ch <= 8505) || (ch >= 8509 && ch <= 8511) || (ch >= 8517 && ch <= 8521) || (ch >= 8544 && ch <= 8579) || (ch >= 12293 && ch <= 12295) || (ch >= 12321 && ch <= 12335) || (ch >= 12337 && ch <= 12341) || (ch >= 12344 && ch <= 12348) || (ch >= 12353 && ch <= 12438) || (ch >= 12441 && ch <= 12442) || (ch >= 12445 && ch <= 12447) || (ch >= 12449 && ch <= 12538) || (ch >= 12540 && ch <= 12543) || (ch >= 12549 && ch <= 12588) || (ch >= 12593 && ch <= 12686) || (ch >= 12704 && ch <= 12727) || (ch >= 12784 && ch <= 12799) || ch == 13312 || ch == 19893 || (ch >= 19968 && ch <= 42124) || ch == 44032 || ch == 55203 || (ch >= 64256 && ch <= 64262) || (ch >= 64275 && ch <= 64279) || (ch >= 64285 && ch <= 64296) || (ch >= 64298 && ch <= 64310) || (ch >= 64312 && ch <= 64316) || ch == 64318 || (ch >= 64320 && ch <= 64321) || (ch >= 64323 && ch <= 64324) || (ch >= 64326 && ch <= 64433) || (ch >= 64467 && ch <= 64829) || (ch >= 64848 && ch <= 64911) || (ch >= 64914 && ch <= 64967) || (ch >= 65008 && ch <= 65019) || (ch >= 65056 && ch <= 65059) || (ch >= 65136 && ch <= 65140) || (ch >= 65142 && ch <= 65276) || ch == 65279 || (ch >= 65296 && ch <= 65305) || (ch >= 65313 && ch <= 65338) || (ch >= 65345 && ch <= 65370) || (ch >= 65382 && ch <= 65470) || (ch >= 65474 && ch <= 65479) || (ch >= 65482 && ch <= 65487) || (ch >= 65490 && ch <= 65495) || (ch >= 65498 && ch <= 65500) || (ch >= 65529 && ch <= 65531)) {AddCh(); goto case_230;}
		...
		case 261:
			...
			else if (ch == L'4') {apx++; AddCh(); goto case_281;}
			else if (ch == L'8') {apx++; AddCh(); goto case_282;}
			else {t->kind = 27; break;}
		case 262:
			case_262:
			...
			else if (ch == 39 || (ch >= L'0' && ch <= L'1')) {apx++; AddCh(); goto case_283;}
			else {goto case_0;}
		case 263:
			case_263:
			...
			else if ((ch >= L'0' && ch <= L'9') || (ch >= L'a' && ch <= L'f')) {apx++; AddCh(); goto case_284;}
			else {goto case_0;}
		case 264:
			case_264:
			...
			else if ((ch >= L'0' && ch <= L'7')) {apx++; AddCh(); goto case_285;}
			else {goto case_0;}
		case 265:
			case_265:
			recEnd = pos; recKind = 26;
			...
			else if (ch == L'd') {AddCh(); goto case_266;}
			else if (ch == L'#') {apx++; AddCh(); goto case_261;}
			else if (ch == L'%') {AddCh(); goto case_85;}
			else if (ch == L'$') {AddCh(); goto case_86;}
			else {t->kind = 26; wchar_t *literal = coco_string_create_lower(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		...
		case 268:
			...
			else if (ch == L'l' || ch == L'r') {AddCh(); goto case_266;}
			else if (ch == L'#') {apx++; AddCh(); goto case_261;}
			else if (ch == L'%') {AddCh(); goto case_85;}
			else if (ch == L'$') {AddCh(); goto case_86;}
			else {t->kind = 26; wchar_t *literal = coco_string_create_lower(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		...
		case 270:
			...
			else if (ch == L'm') {AddCh(); goto case_266;}
			else if (ch == L'#') {apx++; AddCh(); goto case_261;}
			else if (ch == L'%') {AddCh(); goto case_85;}
			else if (ch == L'$') {AddCh(); goto case_86;}
			else {t->kind = 26; wchar_t *literal = coco_string_create_lower(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		case 271:
			case_271:
			if (ch == L'l') {AddCh(); goto case_204;}
			else if (ch == L'n') {AddCh(); goto case_209;}
			else if (ch == L'r') {AddCh(); goto case_215;}
			else {goto case_0;}
		case 272:
			case_272:
		...
		case 273:
			...
			recEnd = pos; recKind = 23;
			if (ch == L'"') {AddCh(); goto case_71;}
			else if (ch == L'/') {AddCh(); goto case_286;}
			else if (ch == 92) {AddCh(); goto case_287;}
			else {t->kind = 23; break;}
		case 274:
			case_274:
			recEnd = pos; recKind = 26;
			...
			else if (ch == L'd') {AddCh(); goto case_288;}
			else {t->kind = 26; wchar_t *literal = coco_string_create_lower(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		case 275:
			case_275:
			recEnd = pos; recKind = 26;
			...
			else if (ch == L'x') {AddCh(); goto case_289;}
			else {t->kind = 26; wchar_t *literal = coco_string_create_lower(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		case 276:
			case_276:
			recEnd = pos; recKind = 26;
			...
			else if (ch == L'n') {AddCh(); goto case_290;}
			else {t->kind = 26; wchar_t *literal = coco_string_create_lower(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		case 277:
			case_277:
			recEnd = pos; recKind = 26;
			...
			else if (ch == L'r') {AddCh(); goto case_291;}
			else {t->kind = 26; wchar_t *literal = coco_string_create_lower(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		case 278:
			case_278:
			{
		...
		case 280:
			...
			recEnd = pos; recKind = 19;
			if ((ch >= L'0' && ch <= L'9')) {AddCh(); goto case_280;}
			else if (ch == L'.') {AddCh(); goto case_292;}
			else if (ch == L'e') {AddCh(); goto case_34;}
			else if (ch == L'_') {AddCh(); goto case_37;}
			else {t->kind = 19; break;}
		case 281:
		...
		case 288:
			case_288:
			recEnd = pos; recKind = 26;
			if ((ch >= L'0' && ch <= L'9') || (ch >= L'a' && ch <= L'z') || ch == 170 || ch == 173 || ch == 181 || ch == 186 || (ch >= 192 && ch <= 214) || (ch >= 216 && ch <= 246) || (ch >= 248 && ch <= 566) || (ch >= 592 && ch <= 705) || (ch >= 710 && ch <= 721) || (ch >= 736 && ch <= 740) || ch == 750 || (ch >= 768 && ch <= 855) || (ch >= 861 && ch <= 879) || ch == 890 || ch == 902 || (ch >= 904 && ch <= 906) || ch == 908 || (ch >= 910 && ch <= 929) || (ch >= 931 && ch <= 974) || (ch >= 976 && ch <= 1013) || (ch >= 1015 && ch <= 1019) || (ch >= 1024 && ch <= 1153) || (ch >= 1155 && ch <= 1158) || (ch >= 1162 && ch <= 1230) || (ch >= 1232 && ch <= 1269) || (ch >= 1272 && ch <= 1273) || (ch >= 1280 && ch <= 1295) || (ch >= 1329 && ch <= 1366) || ch == 1369 || (ch >= 1377 && ch <= 1415) || (ch >= 1425 && ch <= 1441) || (ch >= 1443 && ch <= 1465) || (ch >= 1467 && ch <= 1469) || ch == 1471 || (ch >= 1473 && ch <= 1474) || ch == 1476 || (ch >= 1488 && ch <= 1514) || (ch >= 1520 && ch <= 1522) || (ch >= 1536 && ch <= 1539) || (ch >= 1552 && ch <= 1557) || (ch >= 1569 && ch <= 1594) || (ch >= 1600 && ch <= 1624) || (ch >= 1632 && ch <= 1641) || (ch >= 1646 && ch <= 1747) || (ch >= 1749 && ch <= 1757) || (ch >= 1759 && ch <= 1768) || (ch >= 1770 && ch <= 1788) || ch == 1791 || (ch >= 1807 && ch <= 1866) || (ch >= 1869 && ch <= 1871) || (ch >= 1920 && ch <= 1969) || (ch >= 2305 && ch <= 2361) || (ch >= 2364 && ch <= 2381) || (ch >= 2384 && ch <= 2388) || (ch >= 2392 && ch <= 2403) || (ch >= 2406 && ch <= 2415) || (ch >= 2433 && ch <= 2435) || (ch >= 2437 && ch <= 2444) || (ch >= 2447 && ch <= 2448) || (ch >= 2451 && ch <= 2472) || (ch >= 2474 && ch <= 2480) || ch == 2482 || (ch >= 2486 && ch <= 2489) || (ch >= 2492 && ch <= 2500) || (ch >= 2503 && ch <= 2504) || (ch >= 2507 && ch <= 2509) || ch == 2519 || (ch >= 2524 && ch <= 2525) || (ch >= 2527 && ch <= 2531) || (ch >= 2534 && ch <= 2545) || (ch >= 2561 && ch <= 2563) || (ch >= 2565 && ch <= 2570) || (ch >= 2575 && ch <= 2576) || (ch >= 2579 && ch <= 2600) || (ch >= 2602 && ch <= 2608) || (ch >= 2610 && ch <= 2611) || (ch >= 2613 && ch <= 2614) || (ch >= 2616 && ch <= 2617) || ch == 2620 || (ch >= 2622 && ch <= 2626) || (ch >= 2631 && ch <= 2632) || (ch >= 2635 && ch <= 2637) || (ch >= 2649 && ch <= 2652) || ch == 2654 || (ch >= 2662 && ch <= 2676) || (ch >= 2689 && ch <= 2691) || (ch >= 2693 && ch <= 2701) || (ch >= 2703 && ch <= 2705) || (ch >= 2707 && ch <= 2728) || (ch >= 2730 && ch <= 2736) || (ch >= 2738 && ch <= 2739) || (ch >= 2741 && ch <= 2745) || (ch >= 2748 && ch <= 2757) || (ch >= 2759 && ch <= 2761) || (ch >= 2763 && ch <= 2765) || ch == 2768 || (ch >= 2784 && ch <= 2787) || (ch >= 2790 && ch <= 2799) || (ch >= 2817 && ch <= 2819) || (ch >= 2821 && ch <= 2828) || (ch >= 2831 && ch <= 2832) || (ch >= 2835 && ch <= 2856) || (ch >= 2858 && ch <= 2864) || (ch >= 2866 && ch <= 2867) || (ch >= 2869 && ch <= 2873) || (ch >= 2876 && ch <= 2883) || (ch >= 2887 && ch <= 2888) || (ch >= 2891 && ch <= 2893) || (ch >= 2902 && ch <= 2903) || (ch >= 2908 && ch <= 2909) || (ch >= 2911 && ch <= 2913) || (ch >= 2918 && ch <= 2927) || ch == 2929 || (ch >= 2946 && ch <= 2947) || (ch >= 2949 && ch <= 2954) || (ch >= 2958 && ch <= 2960) || (ch >= 2962 && ch <= 2965) || (ch >= 2969 && ch <= 2970) || ch == 2972 || (ch >= 2974 && ch <= 2975) || (ch >= 2979 && ch <= 2980) || (ch >= 2984 && ch <= 2986) || (ch >= 2990 && ch <= 2997) || (ch >= 2999 && ch <= 3001) || (ch >= 3006 && ch <= 3010) || (ch >= 3014 && ch <= 3016) || (ch >= 3018 && ch <= 3021) || ch == 3031 || (ch >= 3047 && ch <= 3055) || (ch >= 3073 && ch <= 3075) || (ch >= 3077 && ch <= 3084) || (ch >= 3086 && ch <= 3088) || (ch >= 3090 && ch <= 3112) || (ch >= 3114 && ch <= 3123) || (ch >= 3125 && ch <= 3129) || (ch >= 3134 && ch <= 3140) || (ch >= 3142 && ch <= 3144) || (ch >= 3146 && ch <= 3149) || (ch >= 3157 && ch <= 3158) || (ch >= 3168 && ch <= 3169) || (ch >= 3174 && ch <= 3183) || (ch >= 3202 && ch <= 3203) || (ch >= 3205 && ch <= 3212) || (ch >= 3214 && ch <= 3216) || (ch >= 3218 && ch <= 3240) || (ch >= 3242 && ch <= 3251) || (ch >= 3253 && ch <= 3257) || (ch >= 3260 && ch <= 3268) || (ch >= 3270 && ch <= 3272) || (ch >= 3274 && ch <= 3277) || (ch >= 3285 && ch <= 3286) || ch == 3294 || (ch >= 3296 && ch <= 3297) || (ch >= 3302 && ch <= 3311) || (ch >= 3330 && ch <= 3331) || (ch >= 3333 && ch <= 3340) || (ch >= 3342 && ch <= 3344) || (ch >= 3346 && ch <= 3368) || (ch >= 3370 && ch <= 3385) || (ch >= 3390 && ch <= 3395) || (ch >= 3398 && ch <= 3400) || (ch >= 3402 && ch <= 3405) || ch == 3415 || (ch >= 3424 && ch <= 3425) || (ch >= 3430 && ch <= 3439) || (ch >= 3458 && ch <= 3459) || (ch >= 3461 && ch <= 3478) || (ch >= 3482 && ch <= 3505) || (ch >= 3507 && ch <= 3515) || ch == 3517 || (ch >= 3520 && ch <= 3526) || ch == 3530 || (ch >= 3535 && ch <= 3540) || ch == 3542 || (ch >= 3544 && ch <= 3551) || (ch >= 3570 && ch <= 3571) || (ch >= 3585 && ch <= 3642) || (ch >= 3648 && ch <= 3662) || (ch >= 3664 && ch <= 3673) || (ch >= 3713 && ch <= 3714) || ch == 3716 || (ch >= 3719 && ch <= 3720) || ch == 3722 || ch == 3725 || (ch >= 3732 && ch <= 3735) || (ch >= 3737 && ch <= 3743) || (ch >= 3745 && ch <= 3747) || ch == 3749 || ch == 3751 || (ch >= 3754 && ch <= 3755) || (ch >= 3757 && ch <= 3769) || (ch >= 3771 && ch <= 3773) || (ch >= 3776 && ch <= 3780) || ch == 3782 || (ch >= 3784 && ch <= 3789) || (ch >= 3792 && ch <= 3801) || (ch >= 3804 && ch <= 3805) || ch == 3840 || (ch >= 3864 && ch <= 3865) || (ch >= 3872 && ch <= 3881) || ch == 3893 || ch == 3895 || ch == 3897 || (ch >= 3902 && ch <= 3911) || (ch >= 3913 && ch <= 3946) || (ch >= 3953 && ch <= 3972) || (ch >= 3974 && ch <= 3979) || (ch >= 3984 && ch <= 3991) || (ch >= 3993 && ch <= 4028) || ch == 4038 || (ch >= 4096 && ch <= 4129) || (ch >= 4131 && ch <= 4135) || (ch >= 4137 && ch <= 4138) || (ch >= 4140 && ch <= 4146) || (ch >= 4150 && ch <= 4153) || (ch >= 4160 && ch <= 4169) || (ch >= 4176 && ch <= 4185) || (ch >= 4256 && ch <= 4293) || (ch >= 4304 && ch <= 4344) || (ch >= 4352 && ch <= 4441) || (ch >= 4447 && ch <= 4514) || (ch >= 4520 && ch <= 4601) || (ch >= 4608 && ch <= 4614) || (ch >= 4616 && ch <= 4678) || ch == 4680 || (ch >= 4682 && ch <= 4685) || (ch >= 4688 && ch <= 4694) || ch == 4696 || (ch >= 4698 && ch <= 4701) || (ch >= 4704 && ch <= 4742) || ch == 4744 || (ch >= 4746 && ch <= 4749) || (ch >= 4752 && ch <= 4782) || ch == 4784 || (ch >= 4786 && ch <= 4789) || (ch >= 4792 && ch <= 4798) || ch == 4800 || (ch >= 4802 && ch <= 4805) || (ch >= 4808 && ch <= 4814) || (ch >= 4816 && ch <= 4822) || (ch >= 4824 && ch <= 4846) || (ch >= 4848 && ch <= 4878) || ch == 4880 || (ch >= 4882 && ch <= 4885) || (ch >= 4888 && ch <= 4894) || (ch >= 4896 && ch <= 4934) || (ch >= 4936 && ch <= 4954) || (ch >= 4969 && ch <= 4977) || (ch >= 5024 && ch <= 5108) || (ch >= 5121 && ch <= 5740) || (ch >= 5743 && ch <= 5750) || (ch >= 5761 && ch <= 5786) || (ch >= 5792 && ch <= 5866) || (ch >= 5870 && ch <= 5872) || (ch >= 5888 && ch <= 5900) || (ch >= 5902 && ch <= 5908) || (ch >= 5920 && ch <= 5940) || (ch >= 5952 && ch <= 5971) || (ch >= 5984 && ch <= 5996) || (ch >= 5998 && ch <= 6000) || (ch >= 6002 && ch <= 6003) || (ch >= 6016 && ch <= 6099) || ch == 6103 || (ch >= 6108 && ch <= 6109) || (ch >= 6112 && ch <= 6121) || (ch >= 6155 && ch <= 6157) || (ch >= 6160 && ch <= 6169) || (ch >= 6176 && ch <= 6263) || (ch >= 6272 && ch <= 6313) || (ch >= 6400 && ch <= 6428) || (ch >= 6432 && ch <= 6443) || (ch >= 6448 && ch <= 6459) || (ch >= 6470 && ch <= 6509) || (ch >= 7424 && ch <= 7531) || (ch >= 7680 && ch <= 7835) || (ch >= 7840 && ch <= 7929) || (ch >= 7936 && ch <= 7957) || (ch >= 7960 && ch <= 7965) || (ch >= 7968 && ch <= 8005) || (ch >= 8008 && ch <= 8013) || (ch >= 8016 && ch <= 8023) || ch == 8025 || ch == 8027 || ch == 8029 || (ch >= 8031 && ch <= 8061) || (ch >= 8064 && ch <= 8116) || (ch >= 8118 && ch <= 8124) || ch == 8126 || (ch >= 8130 && ch <= 8132) || (ch >= 8134 && ch <= 8140) || (ch >= 8144 && ch <= 8147) || (ch >= 8150 && ch <= 8155) || (ch >= 8160 && ch <= 8172) || (ch >= 8178 && ch <= 8180) || (ch >= 8182 && ch <= 8188) || (ch >= 8203 && ch <= 8207) || (ch >= 8234 && ch <= 8238) || (ch >= 8288 && ch <= 8291) || (ch >= 8298 && ch <= 8303) || ch == 8305 || ch == 8319 || (ch >= 8400 && ch <= 8412) || ch == 8417 || (ch >= 8421 && ch <= 8426) || ch == 8450 || ch == 8455 || (ch >= 8458 && ch <= 8467) || ch == 8469 || (ch >= 8473 && ch <= 8477) || ch == 8484 || ch == 8486 || ch == 8488 || (ch >= 8490 && ch <= 8493) || (ch >= 8495 && ch <= 8497) || (ch >= 8499 && ch <= 8505) || (ch >= 8509 && ch <= 8511) || (ch >= 8517 && ch <= 8521) || (ch >= 8544 && ch <= 8579) || (ch >= 12293 && ch <= 12295) || (ch >= 12321 && ch <= 12335) || (ch >= 12337 && ch <= 12341) || (ch >= 12344 && ch <= 12348) || (ch >= 12353 && ch <= 12438) || (ch >= 12441 && ch <= 12442) || (ch >= 12445 && ch <= 12447) || (ch >= 12449 && ch <= 12538) || (ch >= 12540 && ch <= 12543) || (ch >= 12549 && ch <= 12588) || (ch >= 12593 && ch <= 12686) || (ch >= 12704 && ch <= 12727) || (ch >= 12784 && ch <= 12799) || ch == 13312 || ch == 19893 || (ch >= 19968 && ch <= 42124) || ch == 44032 || ch == 55203 || (ch >= 64256 && ch <= 64262) || (ch >= 64275 && ch <= 64279) || (ch >= 64285 && ch <= 64296) || (ch >= 64298 && ch <= 64310) || (ch >= 64312 && ch <= 64316) || ch == 64318 || (ch >= 64320 && ch <= 64321) || (ch >= 64323 && ch <= 64324) || (ch >= 64326 && ch <= 64433) || (ch >= 64467 && ch <= 64829) || (ch >= 64848 && ch <= 64911) || (ch >= 64914 && ch <= 64967) || (ch >= 65008 && ch <= 65019) || (ch >= 65056 && ch <= 65059) || (ch >= 65136 && ch <= 65140) || (ch >= 65142 && ch <= 65276) || ch == 65279 || (ch >= 65296 && ch <= 65305) || (ch >= 65313 && ch <= 65338) || (ch >= 65345 && ch <= 65370) || (ch >= 65382 && ch <= 65470) || (ch >= 65474 && ch <= 65479) || (ch >= 65482 && ch <= 65487) || (ch >= 65490 && ch <= 65495) || (ch >= 65498 && ch <= 65500) || (ch >= 65529 && ch <= 65531)) {apx = 0; AddCh(); goto case_230;}
			else if (ch == L'_' || (ch >= 8255 && ch <= 8256) || ch == 8276 || ch == 12539 || (ch >= 65075 && ch <= 65076) || (ch >= 65101 && ch <= 65103) || ch == 65343 || ch == 65381) {apx = 0; AddCh(); goto case_260;}
			else if (ch == 10 || ch == 13 || ch == 39 || ch == L'/' || ch == 133 || (ch >= 8232 && ch <= 8233)) {apx++; AddCh(); goto case_94;}
			else if (ch == 9 || ch == L' ') {apx++; AddCh(); goto case_293;}
			else if (ch == L'#') {apx++; AddCh(); goto case_261;}
		...
		case 289:
			...
			else if (ch == L't') {AddCh(); goto case_294;}
			else {t->kind = 26; wchar_t *literal = coco_string_create_lower(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		case 290:
			case_290:
			recEnd = pos; recKind = 26;
			...
			else if (ch == L'd') {AddCh(); goto case_295;}
			else {t->kind = 26; wchar_t *literal = coco_string_create_lower(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		case 291:
			case_291:
			recEnd = pos; recKind = 26;
			...
			else if (ch == 9 || ch == L' ') {apx++; AddCh(); goto case_296;}
			else if (ch == 10 || ch == 13 || ch == 39 || ch == L'/' || ch == 133 || (ch >= 8232 && ch <= 8233)) {apx++; AddCh(); goto case_187;}
			else if (ch == L'#') {apx++; AddCh(); goto case_261;}
			else if (ch == L'%') {AddCh(); goto case_85;}
			else if (ch == L'$') {AddCh(); goto case_86;}
			else {t->kind = 26; wchar_t *literal = coco_string_create_lower(tval, 0, tlen); t->kind = keywords.get(literal, t->kind); coco_string_delete(literal); break;}
		...
		case 293:
			...
			else if (ch == L'c') {apx = 0; AddCh(); goto case_297;}
			else if (ch == L'd') {apx = 0; AddCh(); goto case_255;}
			else if (ch == L'e') {apx = 0; AddCh(); goto case_125;}
			else if (ch == L'f') {apx = 0; AddCh(); goto case_298;}
			else if (ch == L'i') {apx = 0; AddCh(); goto case_143;}
			else if (ch == L'm') {apx = 0; AddCh(); goto case_146;}
			else if (ch == L'o') {apx = 0; AddCh(); goto case_153;}
			else if (ch == L's') {apx = 0; AddCh(); goto case_299;}
			else if (ch == L't') {apx = 0; AddCh(); goto case_300;}
			else if (ch == L'w') {apx = 0; AddCh(); goto case_182;}
		...
		case 296:
			case_296:
			if (ch == 9 || ch == L' ') {apx++; AddCh(); goto case_296;}
			else if ((ch >= L'a' && ch <= L'd') || (ch >= L'f' && ch <= L'z') || ch == 170 || ch == 181 || ch == 186 || (ch >= 192 && ch <= 214) || (ch >= 216 && ch <= 246) || (ch >= 248 && ch <= 566) || (ch >= 592 && ch <= 705) || (ch >= 710 && ch <= 721) || (ch >= 736 && ch <= 740) || ch == 750 || ch == 890 || ch == 902 || (ch >= 904 && ch <= 906) || ch == 908 || (ch >= 910 && ch <= 929) || (ch >= 931 && ch <= 974) || (ch >= 976 && ch <= 1013) || (ch >= 1015 && ch <= 1019) || (ch >= 1024 && ch <= 1153) || (ch >= 1162 && ch <= 1230) || (ch >= 1232 && ch <= 1269) || (ch >= 1272 && ch <= 1273) || (ch >= 1280 && ch <= 1295) || (ch >= 1329 && ch <= 1366) || ch == 1369 || (ch >= 1377 && ch <= 1415) || (ch >= 1488 && ch <= 1514) || (ch >= 1520 && ch <= 1522) || (ch >= 1569 && ch <= 1594) || (ch >= 1600 && ch <= 1610) || (ch >= 1646 && ch <= 1647) || (ch >= 1649 && ch <= 1747) || ch == 1749 || (ch >= 1765 && ch <= 1766) || (ch >= 1774 && ch <= 1775) || (ch >= 1786 && ch <= 1788) || ch == 1791 || ch == 1808 || (ch >= 1810 && ch <= 1839) || (ch >= 1869 && ch <= 1871) || (ch >= 1920 && ch <= 1957) || ch == 1969 || (ch >= 2308 && ch <= 2361) || ch == 2365 || ch == 2384 || (ch >= 2392 && ch <= 2401) || (ch >= 2437 && ch <= 2444) || (ch >= 2447 && ch <= 2448) || (ch >= 2451 && ch <= 2472) || (ch >= 2474 && ch <= 2480) || ch == 2482 || (ch >= 2486 && ch <= 2489) || ch == 2493 || (ch >= 2524 && ch <= 2525) || (ch >= 2527 && ch <= 2529) || (ch >= 2544 && ch <= 2545) || (ch >= 2565 && ch <= 2570) || (ch >= 2575 && ch <= 2576) || (ch >= 2579 && ch <= 2600) || (ch >= 2602 && ch <= 2608) || (ch >= 2610 && ch <= 2611) || (ch >= 2613 && ch <= 2614) || (ch >= 2616 && ch <= 2617) || (ch >= 2649 && ch <= 2652) || ch == 2654 || (ch >= 2674 && ch <= 2676) || (ch >= 2693 && ch <= 2701) || (ch >= 2703 && ch <= 2705) || (ch >= 2707 && ch <= 2728) || (ch >= 2730 && ch <= 2736) || (ch >= 2738 && ch <= 2739) || (ch >= 2741 && ch <= 2745) || ch == 2749 || ch == 2768 || (ch >= 2784 && ch <= 2785) || (ch >= 2821 && ch <= 2828) || (ch >= 2831 && ch <= 2832) || (ch >= 2835 && ch <= 2856) || (ch >= 2858 && ch <= 2864) || (ch >= 2866 && ch <= 2867) || (ch >= 2869 && ch <= 2873) || ch == 2877 || (ch >= 2908 && ch <= 2909) || (ch >= 2911 && ch <= 2913) || ch == 2929 || ch == 2947 || (ch >= 2949 && ch <= 2954) || (ch >= 2958 && ch <= 2960) || (ch >= 2962 && ch <= 2965) || (ch >= 2969 && ch <= 2970) || ch == 2972 || (ch >= 2974 && ch <= 2975) || (ch >= 2979 && ch <= 2980) || (ch >= 2984 && ch <= 2986) || (ch >= 2990 && ch <= 2997) || (ch >= 2999 && ch <= 3001) || (ch >= 3077 && ch <= 3084) || (ch >= 3086 && ch <= 3088) || (ch >= 3090 && ch <= 3112) || (ch >= 3114 && ch <= 3123) || (ch >= 3125 && ch <= 3129) || (ch >= 3168 && ch <= 3169) || (ch >= 3205 && ch <= 3212) || (ch >= 3214 && ch <= 3216) || (ch >= 3218 && ch <= 3240) || (ch >= 3242 && ch <= 3251) || (ch >= 3253 && ch <= 3257) || ch == 3261 || ch == 3294 || (ch >= 3296 && ch <= 3297) || (ch >= 3333 && ch <= 3340) || (ch >= 3342 && ch <= 3344) || (ch >= 3346 && ch <= 3368) || (ch >= 3370 && ch <= 3385) || (ch >= 3424 && ch <= 3425) || (ch >= 3461 && ch <= 3478) || (ch >= 3482 && ch <= 3505) || (ch >= 3507 && ch <= 3515) || ch == 3517 || (ch >= 3520 && ch <= 3526) || (ch >= 3585 && ch <= 3632) || (ch >= 3634 && ch <= 3635) || (ch >= 3648 && ch <= 3654) || (ch >= 3713 && ch <= 3714) || ch == 3716 || (ch >= 3719 && ch <= 3720) || ch == 3722 || ch == 3725 || (ch >= 3732 && ch <= 3735) || (ch >= 3737 && ch <= 3743) || (ch >= 3745 && ch <= 3747) || ch == 3749 || ch == 3751 || (ch >= 3754 && ch <= 3755) || (ch >= 3757 && ch <= 3760) || (ch >= 3762 && ch <= 3763) || ch == 3773 || (ch >= 3776 && ch <= 3780) || ch == 3782 || (ch >= 3804 && ch <= 3805) || ch == 3840 || (ch >= 3904 && ch <= 3911) || (ch >= 3913 && ch <= 3946) || (ch >= 3976 && ch <= 3979) || (ch >= 4096 && ch <= 4129) || (ch >= 4131 && ch <= 4135) || (ch >= 4137 && ch <= 4138) || (ch >= 4176 && ch <= 4181) || (ch >= 4256 && ch <= 4293) || (ch >= 4304 && ch <= 4344) || (ch >= 4352 && ch <= 4441) || (ch >= 4447 && ch <= 4514) || (ch >= 4520 && ch <= 4601) || (ch >= 4608 && ch <= 4614) || (ch >= 4616 && ch <= 4678) || ch == 4680 || (ch >= 4682 && ch <= 4685) || (ch >= 4688 && ch <= 4694) || ch == 4696 || (ch >= 4698 && ch <= 4701) || (ch >= 4704 && ch <= 4742) || ch == 4744 || (ch >= 4746 && ch <= 4749) || (ch >= 4752 && ch <= 4782) || ch == 4784 || (ch >= 4786 && ch <= 4789) || (ch >= 4792 && ch <= 4798) || ch == 4800 || (ch >= 4802 && ch <= 4805) || (ch >= 4808 && ch <= 4814) || (ch >= 4816 && ch <= 4822) || (ch >= 4824 && ch <= 4846) || (ch >= 4848 && ch <= 4878) || ch == 4880 || (ch >= 4882 && ch <= 4885) || (ch >= 4888 && ch <= 4894) || (ch >= 4896 && ch <= 4934) || (ch >= 4936 && ch <= 4954) || (ch >= 5024 && ch <= 5108) || (ch >= 5121 && ch <= 5740) || (ch >= 5743 && ch <= 5750) || (ch >= 5761 && ch <= 5786) || (ch >= 5792 && ch <= 5866) || (ch >= 5870 && ch <= 5872) || (ch >= 5888 && ch <= 5900) || (ch >= 5902 && ch <= 5905) || (ch >= 5920 && ch <= 5937) || (ch >= 5952 && ch <= 5969) || (ch >= 5984 && ch <= 5996) || (ch >= 5998 && ch <= 6000) || (ch >= 6016 && ch <= 6067) || ch == 6103 || ch == 6108 || (ch >= 6176 && ch <= 6263) || (ch >= 6272 && ch <= 6312) || (ch >= 6400 && ch <= 6428) || (ch >= 6480 && ch <= 6509) || (ch >= 7424 && ch <= 7531) || (ch >= 7680 && ch <= 7835) || (ch >= 7840 && ch <= 7929) || (ch >= 7936 && ch <= 7957) || (ch >= 7960 && ch <= 7965) || (ch >= 7968 && ch <= 8005) || (ch >= 8008 && ch <= 8013) || (ch >= 8016 && ch <= 8023) || ch == 8025 || ch == 8027 || ch == 8029 || (ch >= 8031 && ch <= 8061) || (ch >= 8064 && ch <= 8116) || (ch >= 8118 && ch <= 8124) || ch == 8126 || (ch >= 8130 && ch <= 8132) || (ch >= 8134 && ch <= 8140) || (ch >= 8144 && ch <= 8147) || (ch >= 8150 && ch <= 8155) || (ch >= 8160 && ch <= 8172) || (ch >= 8178 && ch <= 8180) || (ch >= 8182 && ch <= 8188) || ch == 8305 || ch == 8319 || ch == 8450 || ch == 8455 || (ch >= 8458 && ch <= 8467) || ch == 8469 || (ch >= 8473 && ch <= 8477) || ch == 8484 || ch == 8486 || ch == 8488 || (ch >= 8490 && ch <= 8493) || (ch >= 8495 && ch <= 8497) || (ch >= 8499 && ch <= 8505) || (ch >= 8509 && ch <= 8511) || (ch >= 8517 && ch <= 8521) || (ch >= 8544 && ch <= 8579) || (ch >= 12293 && ch <= 12295) || (ch >= 12321 && ch <= 12329) || (ch >= 12337 && ch <= 12341) || (ch >= 12344 && ch <= 12348) || (ch >= 12353 && ch <= 12438) || (ch >= 12445 && ch <= 12447) || (ch >= 12449 && ch <= 12538) || (ch >= 12540 && ch <= 12543) || (ch >= 12549 && ch <= 12588) || (ch >= 12593 && ch <= 12686) || (ch >= 12704 && ch <= 12727) || (ch >= 12784 && ch <= 12799) || ch == 13312 || ch == 19893 || (ch >= 19968 && ch <= 42124) || ch == 44032 || ch == 55203 || (ch >= 64256 && ch <= 64262) || (ch >= 64275 && ch <= 64279) || ch == 64285 || (ch >= 64287 && ch <= 64296) || (ch >= 64298 && ch <= 64310) || (ch >= 64312 && ch <= 64316) || ch == 64318 || (ch >= 64320 && ch <= 64321) || (ch >= 64323 && ch <= 64324) || (ch >= 64326 && ch <= 64433) || (ch >= 64467 && ch <= 64829) || (ch >= 64848 && ch <= 64911) || (ch >= 64914 && ch <= 64967) || (ch >= 65008 && ch <= 65019) || (ch >= 65136 && ch <= 65140) || (ch >= 65142 && ch <= 65276) || (ch >= 65313 && ch <= 65338) || (ch >= 65345 && ch <= 65370) || (ch >= 65382 && ch <= 65470) || (ch >= 65474 && ch <= 65479) || (ch >= 65482 && ch <= 65487) || (ch >= 65490 && ch <= 65495) || (ch >= 65498 && ch <= 65500)) {apx++; AddCh(); goto case_189;}
			else if (ch == 10 || ch == 13 || ch == 39 || ch == L'/' || ch == 133 || (ch >= 8232 && ch <= 8233)) {apx++; AddCh(); goto case_188;}
			else if (ch == L'e') {apx++; AddCh(); goto case_301;}
			else {goto case_0;}
		case 297:
			case_297:
		...
		case 299:
			...
			else if (ch == L't') {AddCh(); goto case_166;}
			else if (ch == L'u') {AddCh(); goto case_172;}
			else {goto case_0;}
		case 300:
			case_300:
			if (ch == L'r') {AddCh(); goto case_302;}
			else {goto case_0;}
		case 301:
			case_301:
			recEnd = pos; recKind = 56;
			if (ch == L'a') {apx = 0; AddCh(); goto case_190;}
			else {
				tlen -= apx;
				SetScannerBehindT();				buffer->SetPos(t->pos); NextCh(); line = t->line; col = t->col;
				for (int i = 0; i < tlen; i++) NextCh();
		...
		case 302:
			case_302:
			if (ch == L'a') {AddCh(); goto case_175;}
			else if (ch == L'y') {AddCh(); goto case_179;}
			else {goto case_0;}
		case 303:
			case_303:
			{t->kind = 82; break;}
