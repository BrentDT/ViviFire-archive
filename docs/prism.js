...
/*
** Parts highlighter, by Brent D Thorn, 2013
*/

var parts = document.getElementById("parts");
if (parts && parts.childElementCount) {
	var dx = parts.children;
	for (var i = 0; i < dx.length; i++) {
		if (dx[i].nodeName == "DT" && dx[i].textContent.search(reKeywords) == 0) {
			dx[i].className = "keyword";
		}
	}
}
